...
TUNING.WILLIAM_HEALTH = 120
TUNING.WILLIAM_HUNGER = 150
TUNING.WILLIAM_SANITY = 200
TUNING.WILLIAM_DAMAGE = 0.9
...
TUNING.WILLIAM_BALLISTIC_HEALTH = 200
TUNING.WILLIAM_BALLISTIC_ATTACK_PERIOD = 3
TUNING.WILLIAM_BALLISTIC_DAMAGE = 27.2
TUNING.WILLIAM_BALLISTIC_MAXFUEL = seg_time*30
...
TUNING.WILLIAM_BUSTER_MAXFUEL = seg_time*30
