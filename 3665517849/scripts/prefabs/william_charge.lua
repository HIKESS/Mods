...
local function OnHit(inst, owner, target)
	...
	target.components.combat:GetAttacked(no_aggro(owner, target) == false and owner or nil , TUNING.WILLIAM_BALLISTIC_DAMAGE , inst, "electric")
    end
    inst:Remove()
end
