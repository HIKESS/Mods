...
return {
	ACTIONFAIL =
	{
        REPAIR =
        {
            WRONGPIECE = "Oh, dear. That wasn't right.",
        },
        BUILD =
        {
            MOUNTED = "A little high up, aren't I?",
            HASPET = "I've no room left in my entourage!",
        },
		SHAVE =
		{
			AWAKEBEEFALO = "Let it sleep, I say!",
			GENERIC = "There's nothing to shave here!",
			NOBITS = "Ho-ho! Smooth as a baby's backside!",
		},
		STORE =
		{
			GENERIC = "It's overflowing already!",
			NOTALLOWED = "That would be unwise!",
			INUSE = "I shall wait for my turn!",
            NOTMASTERCHEF = "I should trust a better cook with that.",
		},
        CONSTRUCT =
        {
            INUSE = "My good friend has this under control!",
            NOTALLOWED = "No, no that's not right at all...",
            EMPTY = "We'll have to get started.",
            MISMATCH = "Fiddlesticks!",
        },
		RUMMAGE =
		{	
			GENERIC = "Now isn't the time for that!",
			INUSE = "Someone else is rummaging through.",
            NOTMASTERCHEF = "I should trust a better cook with that.",
		},
		UNLOCK =
        {
		...
		USEKLAUSSACKKEY =
        {
        	WRONGKEY = "Drats! That didn't fit.",
        	KLAUS = "Right now?! Are you mad?!",
			QUAGMIRE_WRONGKEY = "Hmm... seems that was the wrong key.",
        },
		ACTIVATE = 
		{
			LOCKED_GATE = "The key must be around here, somewhere.",
		},
        COOK =
        {
            GENERIC = "Woops! Butter fingers.",
            INUSE = "Please do clean up after you're finished!",
            TOOFAR = "If only my arms were longer...",
        },
        
        FISH_OCEAN =
		{
			TOODEEP = "We'll need a bigger rod!",
		},
        OCEAN_FISHING_POND =
		{
			WRONGGEAR = "This rod is a tad much for that.",
		},

        GIVE =
        {
            GENERIC = "That's not a good mix.",
            DEAD = "Hmm... another time, perhaps.",
            SLEEPING = "I'll not wake them!",
            BUSY = "My bad! I shall wait.",
            ABIGAILHEART = "I'm sorry I couldn't help more.",
            GHOSTHEART = "Uh, no...?",
            NOTGEM = "Clearly, it requres a gem!",
            WRONGGEM = "Wrong gem!",
            NOTSTAFF = "Bah! Clumsy old me.",
            MUSHROOMFARM_NEEDSSHROOM = "It needs a mushroom!",
            MUSHROOMFARM_NEEDSLOG = "It needs something more... magical!",
            SLOTFULL = "No room there.",
            FOODFULL = "Let the beast feast!",
            NOTDISH = "That's not for food!",
            DUPLICATE = "The plans are already there!",
            NOTSCULPTABLE = "Hardly suitable for sculpting!",
            NOTATRIUMKEY = "It was worth a shot?",
            CANTSHADOWREVIVE = "Did I do something wrong?",
            WRONGSHADOWFORM = "The bones look a tad mismatched.",
            NOMOON = "Seems this needs the moon to work...",
			PIGKINGGAME_MESSY = "The grounds must be cleaned up!",
			PIGKINGGAME_DANGER = "We don't want these beasties getting involved!",
			PIGKINGGAME_TOOLATE = "Can't we play in the morning?",
        },
        GIVETOPLAYER =
        {
            FULL = "They have enough on their shoulders as is!",
            DEAD = "I shall be keeping this to myself!",
            SLEEPING = "It would be rude to wake them.",
            BUSY = "Oh, I didn't mean to bother you.",
        },
        GIVEALLTOPLAYER =
        {
            FULL = "They have enough on their shoulders as is!",
        ...
        WRITE =
        {
            GENERIC = "Why fix what isn't broken?",
            INUSE = "I'll not impose myself on their creation!",
        },
        DRAW =
        {
            NOIMAGE = "Ah...and what should I draw, then?",
        },
        CHANGEIN =
        {
            GENERIC = "Am I not looking sharp enough?",
            BURNING = "No! My socks were in there!",
            INUSE = "I'm sure they're planning something wonderful!",
        },
        ATTUNE =
        {
            NOHEALTH = "My heart couldn't take it!",
        },
        MOUNT =
        {
            TARGETINCOMBAT = "Ehm... I'll wait for it to calm down.",
            INUSE = "I suppose I'll have to walk.",
        },
        SADDLE =
        {
            TARGETINCOMBAT = "I'll just have to wait for it to calm down.",
        },
        TEACH =
        {
            --Recipes/Teacher
            KNOWN = "Hah! Two steps ahead.",
            CANTLEARN = "What a load of rubbish.",

            --MapRecorder/MapExplorer
            WRONGWORLD = "I don't believe this is the right map.",
        },
        WRAPBUNDLE =
        {
            EMPTY = "I need something to wrap up!",
        },
        PICKUP =
        {
			RESTRICTION = "I wouldn't know what to do with it.",
			INUSE = "I must wait my turn.",
        },
        SLAUGHTER =
        {
            TOOFAR = "Agh! The beast got away!",
        },
        REPLATE =
        {
            MISMATCH = "Serve this on that? Surely you jest!", 
            SAMEDISH = "I'll not soil another dish needlessly!", 
        },
        SAIL =
        {
        	REPAIR = "Looks to be in ship-shape!",
        },
        ROW_FAIL =
        {
            BAD_TIMING0 = "Fiddlesticks!",
            BAD_TIMING1 = "I wasn't make for sailing!",
            BAD_TIMING2 = "Oh, good heavens...",
        },
        LOWER_SAIL_FAIL =
        {
            "Why isn't it working?",
            "Slow down! Slow down!",
            "Anchor? Anything? We're still going!",
        },
        BATHBOMB =
        {
            GLASSED = "It appears to be glassed over.",
            ALREADY_BOMBED = "Not yet. The last one is still bubbling away!",
        },
		GIVE_TACKLESKETCH =
		{
		...
		COMPARE_WEIGHABLE =
		{
			TOO_SMALL = "Hardly a match for the last.",
		},
	},
	ACTIONFAIL_GENERIC = "Sigh. That could have gone better.",
	ANNOUNCE_BOAT_LEAK = "Oh, dear...",
	ANNOUNCE_BOAT_SINK = "I'm too handsome to die here!",
	ANNOUNCE_DIG_DISEASE_WARNING = "Let's get you back on your feet!",
	ANNOUNCE_PICK_DISEASE_WARNING = "I say! That's a worrying smell.",
	ANNOUNCE_ADVENTUREFAIL = "Well, I'm alive at least...",
    ANNOUNCE_MOUNT_LOWHEALTH = "The poor thing is on death's door.",
	...
	ANNOUNCE_BEES = "WAAAAAAAGH!",
	ANNOUNCE_BOOMERANG = "Waough! Clumsy me!",
	ANNOUNCE_CHARLIE = "Th-that didn't sound friendly...",
	ANNOUNCE_CHARLIE_ATTACK = "Heurgh! Somebody please, save me!!",
	ANNOUNCE_CHARLIE_MISSED = "only_used_by_winona", --winona specific 
	ANNOUNCE_COLD = "Oof, I'm chilled to the bone.",
	ANNOUNCE_HOT = "I say! I'm frying like an egg!",
	ANNOUNCE_CRAFTING_FAIL = "Drats, that didn't do it...",
	ANNOUNCE_DEERCLOPS = "Th-that sounded big!",
	ANNOUNCE_CAVEIN = "The ceiling is coming down ontop of us!",
	ANNOUNCE_ANTLION_SINKHOLE = 
	{
		"There's something under my feet!",
		"The ground is falling apart!",
		"Run! Run! The ground is opening up!",
	},
	ANNOUNCE_ANTLION_TRIBUTE =
	{
        "Please don't kill me or my friends.",
        "A token of my friendship, just for you!",
        "Most delectable, yes?",
	},
	ANNOUNCE_SACREDCHEST_YES = "Ho-ho! Seems I'm worthy.",
	ANNOUNCE_SACREDCHEST_NO = "Hmm... we'll just have to try that again.",
    ANNOUNCE_DUSK = "Dear me, would you look at the time!",
	...
	ANNOUNCE_EAT =
	{
		GENERIC = "Yum!",
		PAINFUL = "Oh, dear...",
		SPOILED = "Well. That was unpleasant.",
		STALE = "That was not too fresh.",
		INVALID = "I can't eat that!",
        YUCKY = "I'm far too dignified for that!",
    ...
    {
        "Ooh... my back...",
        "Wait... why don't I make... my butler do this?",
        "Legs... failing...",
        "Nng...",
        "Ooh...",
        "I'm... dying...",
    ...
    ANNOUNCE_ATRIUM_DESTABILIZING = 
    {
		...
		"The gateway! It's doing... something!",
		"I say! This is no place for old me!",
	},
    ANNOUNCE_RUINS_RESET = "It would appear all the nasties have returned! Curious...",
    ANNOUNCE_SNARED = "Agh! They'll rip my jacket!",
    ANNOUNCE_REPELLED = "We must take down the shield first!",
	ANNOUNCE_ENTER_DARK = "I can't see in this dark!",
	ANNOUNCE_ENTER_LIGHT = "Whew! Thank the light.",
	...
	ANNOUNCE_WORMS = "There's a rumbling under the ground.",
	ANNOUNCE_HUNGRY = "I'm positively famished!",
	ANNOUNCE_HUNT_BEAST_NEARBY = "Tally-ho! The hunt is on!",
	ANNOUNCE_HUNT_LOST_TRAIL = "Shoot! I've lost its trail.",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "The soil is much too wet to hold its tracks.",
	ANNOUNCE_INV_FULL = "My pockets are filled to bursting!",
	...
	ANNOUNCE_THORNS = "Ow!",
	ANNOUNCE_BURNT = "Aiee!! Hot hot hot!",
	...
	ANNOUNCE_TOOL_SLIP = "Oop! Butter fingers.",
	ANNOUNCE_LIGHTNING_DAMAGE_AVOIDED = "Safe from that frightening lightning!",
	ANNOUNCE_TOADESCAPING = "The toad is losing interest.",
	ANNOUNCE_TOADESCAPED = "The toad got away.",ANNOUNCE_RUINS_RESET = "看来所有的可怕生物都回来了！有点好奇...",
    ANNOUNCE_SNARED = "啊！它们会撕破我的夹克！",
    ANNOUNCE_REPELLED = "我们必须先摧毁护盾！",
	ANNOUNCE_ENTER_DARK = "在这么黑暗的地方我什么都看不见！",
	ANNOUNCE_ENTER_LIGHT = "呼！谢天谢地有光。",
	ANNOUNCE_FREEDOM = "我自由了！我终于自由了！",
	ANNOUNCE_HIGHRESEARCH = "现在我感觉好聪明！",
	ANNOUNCE_HOUNDS = "外面有东西！",
	ANNOUNCE_WORMS = "地下传来一阵颤动声。",
	ANNOUNCE_HUNGRY = "我饿极了！",
	ANNOUNCE_HUNT_BEAST_NEARBY = "出发！开始追逐！",
	ANNOUNCE_HUNT_LOST_TRAIL = "糟糕！我迷失了它的踪迹。",
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "泥土太湿了，无法留下足迹。",
	ANNOUNCE_INV_FULL = "我的口袋都塞满了！",
	ANNOUNCE_KNOCKEDOUT = "啊，我的头！",
	ANNOUNCE_LOWRESEARCH = "我从中学到的不多。",
	ANNOUNCE_MOSQUITOS = "啊！快走开！",
    ANNOUNCE_NOWARDROBEONFIRE = "衣柜着火了，我不能穿衣服！",
    ANNOUNCE_NODANGERGIFT = "有怪物在附近，我不能打开礼物！",
    ANNOUNCE_NOMOUNTEDGIFT = "我应该先下来摆脱我的牦牛。",
	ANNOUNCE_NODANGERSLEEP = "我现在太害怕死亡了，无法入睡！",
	ANNOUNCE_NODAYSLEEP = "天太亮了，无法入睡。",
	ANNOUNCE_NODAYSLEEP_CAVE = "我不困。",
	ANNOUNCE_NOHUNGERSLEEP = "我太饿了，肚子咕噜咕噜地会让我睡不着！",
	ANNOUNCE_NOSLEEPONFIRE = "我没有强烈的渴望在那里睡觉。",
	ANNOUNCE_NODANGERSIESTA = "现在太危险了，无法午睡！",
	ANNOUNCE_NONIGHTSIESTA = "晚上是用来睡觉的，不是午睡的时候。",
	ANNOUNCE_NONIGHTSIESTA_CAVE = "我觉得我在这里不太能真正放松。",
	ANNOUNCE_NOHUNGERSIESTA = "我太饿了，没法午睡！",
	ANNOUNCE_NODANGERAFK = "现在不是逃避战斗的时候！",
	ANNOUNCE_NO_TRAP = "哦，那很容易。",
	ANNOUNCE_PECKED = "哎呀！别再这样了！",
	ANNOUNCE_QUAKE = "听起来不太好。",
	ANNOUNCE_RESEARCH = "永远不要停止学习！",
	ANNOUNCE_SHELTER = "感谢树提供的遮蔽物，保护我免受风雨侵袭！",
	ANNOUNCE_THORNS = "哎呀！",
	ANNOUNCE_BURNT = "哎呀！！烫手烫手！",
	ANNOUNCE_TORCH_OUT = "我的灯光刚刚用完了！",
	ANNOUNCE_THURIBLE_OUT = "香炉已经用尽了。",
	ANNOUNCE_FAN_OUT = "我的扇子随风飘逝。",
    ANNOUNCE_COMPASS_OUT = "指南针失去了指向。",
	ANNOUNCE_TRAP_WENT_OFF = "糟糕。",
	ANNOUNCE_UNIMPLEMENTED = "疼！我觉得还没准备。",
	...
	BATTLECRY =
	{
		...
		PREY = "Ouwaaaaah!",
		SPIDER = "Aaaaaah!",
		SPIDER_WARRIOR = "Most foul indeed!",
		DEER = "Shoo!",
	},
	COMBAT_QUIT =
	{
		GENERIC = "Hoo... I need a rest.",
		PIG = "Sigh. I hope he doesn't hold a grudge..",
		PREY = "Oh, fine! Be that way.",
		SPIDER = "I believe I broke a sweat.",
		SPIDER_WARRIOR = "And don't come back!",
	},

	DESCRIBE =
	{
		MULTIPLAYER_PORTAL = "That's the last time I meddle with dark magic!",
        MULTIPLAYER_PORTAL_MOONROCK = "Well... is it still dark magic?",
        MOONROCKIDOL = "I don't like this.",
        CONSTRUCTION_PLANS = "I say! This should be fun!",
        ...
        BERNIE_INACTIVE =
        {
            BROKEN = "...A little too much love.",
            GENERIC = "It's seen plenty of tough love.",
        },

        BERNIE_ACTIVE = "The power of imagination can bring anything to love!",
        BERNIE_BIG = "Willow... certainly has an excessive mind.",
        ...
        PLAYER =
        {
            GENERIC = "'Ello there, %s!",
            ATTACKER = "%s looks shifty...",
            MURDERER = "Murderer!",
            REVIVER = "%s, a fine friend indeed!",
            GHOST = "%s could use a heart.",
            FIRESTARTER = "Burning that wasn't very scientific, %s.",
        },
        WILLIAM =
        {
            GENERIC = "What a strapping lad!",
            ATTACKER = "%s has an odd glint in his eye...",
            MURDERER = "You're no... uh, me! Die!",
            REVIVER = "%s, as generous as he is handsome.",
            GHOST = "It would be impolite to not lend a friend a heart.",
            FIRESTARTER = "Burning that wasn't very proper, %s.",
        },
        ...
        WICKERBOTTOM =
        {
            GENERIC = "Well wishes to you, Ms %s!",
            ATTACKER = "I think %s's planning to throw the book at me.",
            MURDERER = "Here comes my peer review!",
            REVIVER = "Oh! What a woman, that %s...",
            GHOST = "Fret not! I'll have a heart for you at once, %s!",
        ...
        MINERHAT = "Hardly fashionable.",
        MONKEY = "Just watch the hat, please!",
        MONKEYBARREL = "Oh-ho-ho! That brings me back.",
        ...
        MOSSLING = "Even more terrible than their mother!",
        ...
        NIGHTLIGHT = "But why?",
        NIGHTMAREFUEL = "I suppose if I'm to lower myself...",
        NIGHTSWORD = "I'm beginning to question my own mind.",
        NITRE = "It's not cooking salt!",
		...
		SKELETON_PLAYER =
		{
			MALE = "%s must have met his untimely end to %s.",
			FEMALE = "%s must have met his untimely end to %s %s.",
			ROBOT = "%s must have met his untimely end to %s %s.",
			DEFAULT = "%s must have met his untimely end to %s %s.",
		},
