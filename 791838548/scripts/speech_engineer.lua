return {
	ACTIONFAIL =
	{
        ...
        BUILD =
        {
			...
			TICOON = "I ain't givin' up on mine just yet!",
			BUILDINGLIMIT = "I built that, can't build no more.",-- engineer specific
        },
		SHAVE =
		{
			...
			SOMEONEELSESBEEFALO = "Ain't my cattle to brand.",
		},
		STORE =
		{
		...
		CONSTRUCT =
        {
			...
			NOTREADY = "How 'bout we wait for things to simmer down?",
        },
		RUMMAGE =
		{
		...
		ACTIVATE = 
		{
			...
			HOSTBUSY = "Let the man do his workin'.",
            CARNIVAL_HOST_HERE = "Now where'd that big fella get to now?",
            NOCARNIVAL = "Ain't no time for games no more.",
			EMPTY_CATCOONDEN = "Ain't nothin'.",
			KITCOON_HIDEANDSEEK_NOT_ENOUGH_HIDERS = "Ain't enough cattle for this rodeo.",
			KITCOON_HIDEANDSEEK_NOT_ENOUGH_HIDING_SPOTS = "Ain't much hidin' room 'round these parts.",
			KITCOON_HIDEANDSEEK_ONE_GAME_PER_DAY = "Thinkin' we're all tuckered out.",
            MANNEQUIN_EQUIPSWAPFAILED = "That ought to look a might better on me.",
			PILLOWFIGHT_NO_HANDPILLOW = "Oughta equip myself with a pillow.",
		},
		OPEN_CRAFTING = 
		{
            PROFESSIONALCHEF = "I ain't the fancy cookin' type. I only mastered barbecue.",
			SHADOWMAGIC = "This ain't anything I'd like to master. Just ain't science.",
		},
        COOK =
        {
            GENERIC = "Is it broke?",
        ...
        GIVE =
        {
            ...
            DEAD = "Wouldn't make use of this ol' thing dead.",
            SLEEPING = "I got a gift waitin' for ya.",
            BUSY = "Not now.",
			ABIGAILHEART = "Just ain't gonna happen.",
			...
			MUSHROOMFARM_NOMOONALLOWED = "Guess we ain't gettin' more.",
            SLOTFULL = "Slot's taken.",
			...
			CARNIVALGAME_INVALID_ITEM = "Oughta purchase a bit of silver.",
			CARNIVALGAME_ALREADY_PLAYING = "Now would ya lookit that!",
            SPIDERNOHAT = "Could think of a few better uses for that there hat.",
			TERRARIUM_REFUSE = "Ought to expand my fuel repertoire.",
            TERRARIUM_COOLDOWN = "I best wait some more.",
            NOTAMONKEY = "Sorry ma'am, can't say I speak primate.",
            QUEENBUSY = "She's got her paws full.",
			NOTMOTHER = "Can't say I got a PhD in nest-matics.", --woose specific
        },
        GIVETOPLAYER = 
        {
        ...
        CHANGEIN =
        {
			...
			NOTENOUGHHAIR = "Ain't much to dolly up.",
            NOOCCUPANT = "Needs a hitchin' partner.",
        },
        ATTUNE =
        {
            NOHEALTH = "Naahhh...",
        ...
        MOUNT =
        {
            ...
            INUSE = "Hope ya know how to ride 'em, pardner.",
			SLEEPING = "Giddy up now!",
        },
        SADDLE =
        {
		...
		TEACH =
        {
            KNOWN = "Gotta try a lot harder than that to teach me things.",
			...
			STASH_MAP_NOT_FOUND = "This ain't no treasure map! Looks like we've been snubbed a good'un.",-- Likely trying to read stash map  in world without stash
        },
		WRAPBUNDLE =
        {
		...
		PICKUP =
        {
			RESTRICTION = "I ain't too keen on doin' that.",
			RESTRICTION_ENGINEER = "Ain't my gear to move up!",
            ...
            FULL_OF_CURSES = "Don't touch that darn thing.",
        },
		SLAUGHTER =
        {
		...
		SAIL =
        {
        	NOWHEEL = "Oughta have a wheel first.",--removed
		...
		COMPARE_WEIGHABLE =
		{
			FISH_TOO_SMALL = "This tank ain't big 'nough for the both of ya!",
            OVERSIZEDVEGGIES_TOO_SMALL = "It ain't no mighty slice.",
		},
		PLANTREGISTRY_RESEARCH_FAIL =
        {
            GENERIC = "Got all I need to learn up here.",
            FERTILIZER = "Don't need a PhD to get that.",
        },
        FILL_OCEAN =
        {
            UNSUITABLE_FOR_PLANTS = "Too salty for ya, now is it?",
        },
        POUR_WATER =
        {
            OUT_OF_WATER = "Well's run dry.",
        },
        ...
        USEITEMON =
        {
            ...
            BEEF_BELL_INVALID_TARGET = "Heck no.",
            BEEF_BELL_ALREADY_USED = "A true cowboy wouldn't use another man's horse.",
            BEEF_BELL_HAS_BEEF_ALREADY = "I'm a one horse man.",
        },
        HITCHUP =
        {
            NEEDBEEF = "Now to find me some cattle!",
            NEEDBEEF_CLOSER = "Come along now.",
            BEEF_HITCHED = "Been hitched.",
            INMOOD = "Best just be a phase.",
        },
        MARK =
        {
            ALREADY_MARKED = "I got mine.",
            NOT_PARTICIPANT = "Got no steak, got no win.",
        },
        YOTB_STARTCONTEST =
        {
            DOESNTWORK = "That's that.",
            ALREADYACTIVE = "This is tryin' my patience.",
        },
        YOTB_UNLOCKSKIN =
        {
            ALREADYKNOWN = "Everybody knows that.",
        },
        CARNIVALGAME_FEED =
        {
            TOO_LATE = "Why you grubless little-!",
        },
        HERD_FOLLOWERS =
        {
            WEBBERONLY = "Not quite my thing.",
        },
		HARVEST =
        {
            DOER_ISNT_MODULE_OWNER = "Shoot. Maybe my wrench ought to get you talkin'.",
        },
	},
	ANNOUNCE_CANNOT_BUILD =
	{
		NO_INGREDIENTS = "I'm missin' some important parts.",
		NO_TECH = "I'm still tinkerin' away at that one's prints...",
		NO_STATION = "Ought to get a workstation if I wanna muster this one up.",
	},
	...
	ANNOUNCE_DIG_DISEASE_WARNING = "Little thing oughta be thankful I saved it before it up and died.",--removed
    ANNOUNCE_PICK_DISEASE_WARNING = "That there plant's gettin' low on health.",--removed
	...
	ANNOUNCE_COLD = "Never this cold in Texas!",
	...
	ANNOUNCE_SNARED_IVY = "You best be playin' nice now!",
	...
	ANNOUNCE_HUNT_LOST_TRAIL_SPRING = "Well, trail's been smudged.",
    ANNOUNCE_HUNT_START_FORK = "Let's go make trouble!",
    ANNOUNCE_HUNT_SUCCESSFUL_FORK = "We're gonna stop these mother-hubbards in their tracks!",
    ANNOUNCE_HUNT_WRONG_FORK = "Awww, hell.",
    ANNOUNCE_HUNT_AVOID_FORK = "Looks like easy pickin's here out.",
	ANNOUNCE_INV_FULL = "I ain't got any more room!",
	...
	ANNOUNCE_NOSLEEPONFIRE = "Sleepin' on flames oughta be my stupidest idea.",
    ANNOUNCE_NOSLEEPHASPERMANENTLIGHT = "You best remember to turn the power off when the sun goes down!",
	...
	ANNOUNCE_BASEBALL_RETURNED = "Lil' baseball's back in the bat.",--tf2scout
	--hallowed nights
	...
	ANNOUNCE_WINTERS_FEAST_BUFF_OVER = "Well, can't be festive every day now can I?",
	--lavaarena event
	...
	ANNOUNCE_SENTRYBUILT = {
        "Sentry goin' up.",
        "Buildin' a Sentry.",
    },
	ANNOUNCE_DISPENSERBUILT = {
        "Dispenser goin' up.",
        "Erectin' a Dispenser.",
    },
	ANNOUNCE_TELEPORTERBUILT = {
        "Teleporter comin' right up.",
        "Teleporter goin' up.",
    },
	ANNOUNCE_NOTMACHINE = {
        "That ain't one of my machines!",
        "This here PDA's built and designed for my machines only.",
    },
	--RoT
	...
	ANNOUNCE_MEGA_FLARE_SEEN = "It must been high noon!",
	...
	ANNOUNCE_ATTACH_BUFF_SLEEPRESISTANCE   = "Whew! I feel the energy to calculate some new blueprints comin' on!",
	...
	ANNOUNCE_DETACH_BUFF_SLEEPRESISTANCE   = "Guess all those new inventions... (yawn) gotta wait some more.",
	...
	ANNOUNCE_POCKETWATCH_PORTAL = "Nearly tore me a structurally superfluous new behind!",

    ANNOUNCE_ARCHIVE_NEW_KNOWLEDGE = "I'm seein' far an' wide, all these...ideas!",
    ANNOUNCE_ARCHIVE_OLD_KNOWLEDGE = "Gotta give me some more to keep me guessin'.",
    ANNOUNCE_ARCHIVE_NO_POWER = "Nothin' like some educated engineerin' won't fix",

    ANNOUNCE_PLANT_RESEARCHED =
    {
        "Guess I'm studyin' plants now!",
    },

    ANNOUNCE_PLANT_RANDOMSEED = "Guess I'll find out another day.",

    ANNOUNCE_FERTILIZER_RESEARCHED = "Think I oughta know enough.",

	ANNOUNCE_FIRENETTLE_TOXIN =
	{
		"Whew-ee! I'm feelin' like a Texas barbecue!",
		"Hot damn! Now that's testin' my tolerance!",
	},
	ANNOUNCE_FIRENETTLE_TOXIN_DONE = "Woo! Might'n just give it another shot.",

	ANNOUNCE_TALK_TO_PLANTS =
	{
        "Ya thinkin' about growin', son?",
        "Let's get you up to level 3!",
		"Listen buddy, I'm an Engineer. I solve practical problems.",
        "Think a hit with my wrench oughta get ya growin'?",
        "Now, let me tell ya the story about the Birds and the Bullets.",
	},

	ANNOUNCE_KITCOON_HIDEANDSEEK_START = "Pony up boys, here I come!",
	ANNOUNCE_KITCOON_HIDEANDSEEK_JOIN = "Got room for one more?",
	ANNOUNCE_KITCOON_HIDANDSEEK_FOUND = 
	{
		"Gotcha!",
		"Gotcha, stretch.",
		"We got 'em now!",
		"Now would ya lookit that!",
	},
	ANNOUNCE_KITCOON_HIDANDSEEK_FOUND_ONE_MORE = "Come on now, just one little fella left.",
	ANNOUNCE_KITCOON_HIDANDSEEK_FOUND_LAST_ONE = "That'll about do it!",
	ANNOUNCE_KITCOON_HIDANDSEEK_FOUND_LAST_ONE_TEAM = "{name} got some mighty fine findin' skills.",
	ANNOUNCE_KITCOON_HIDANDSEEK_TIME_ALMOST_UP = "We're runnin' right outta time!",
	ANNOUNCE_KITCOON_HIDANDSEEK_LOSEGAME = "Aw, shucks.",
	ANNOUNCE_KITCOON_HIDANDSEEK_TOOFAR = "They ain't 'round here.",
	ANNOUNCE_KITCOON_HIDANDSEEK_TOOFAR_RETURN = "Think I'm on their hides now!",
	ANNOUNCE_KITCOON_FOUND_IN_THE_WILD = "Ha! Gotcha, stretch!",

	ANNOUNCE_TICOON_START_TRACKING	= "What's got your tongue?",
	ANNOUNCE_TICOON_NOTHING_TO_TRACK = "Ain't turned up nothin'.",
	ANNOUNCE_TICOON_WAITING_FOR_LEADER = "Guess I better get to gettin'.",
	ANNOUNCE_TICOON_GET_LEADER_ATTENTION = "How much are ya askin' for?",
	ANNOUNCE_TICOON_NEAR_KITCOON = "Looks like he's got a taste.",
	ANNOUNCE_TICOON_LOST_KITCOON = "Looks like we done got bested.",
	ANNOUNCE_TICOON_ABANDONED = "Ain't no job I can't handle on my lonesome.",
	ANNOUNCE_TICOON_DEAD = "Guess it's up to me now.",

    -- YOTB
    ANNOUNCE_CALL_BEEF = "Come along now!",
    ANNOUNCE_CANTBUILDHERE_YOTB_POST = "Need to move this gear up.",
    ANNOUNCE_YOTB_LEARN_NEW_PATTERN =  "That's some blueprints alright. Or was that'un green?",
    -- AE4AE
    ANNOUNCE_EYEOFTERROR_ARRIVE = "Invokum Monoculus!",
    ANNOUNCE_EYEOFTERROR_FLYBACK = "You ready to dance, pardner?",
    ANNOUNCE_EYEOFTERROR_FLYAWAY = "We ain't finished yet!",
    -- PIRATES
    ANNOUNCE_CANT_ESCAPE_CURSE = "Looks I oughta concoct a better solution.",
    ANNOUNCE_MONKEY_CURSE_1 = "I just ain't feelin' myself today!",
    ANNOUNCE_MONKEY_CURSE_CHANGE = "Any of y'all feelin' a might primal?",
    ANNOUNCE_MONKEY_CURSE_CHANGEBACK = "Shucks, now here I was gettin' used to it!",

    ANNOUNCE_PIRATES_ARRIVE = "Head's up! We got a raid!",

    ANNOUNCE_OFF_SCRIPT = "You look a might tongue-tied.",

    ANNOUNCE_COZY_SLEEP = "Whoo! Now that was a damn good nap!",

	--
	ANNOUNCE_TOOL_TOOWEAK = "This darn thing ain't doin' me any favors!",

    ANNOUNCE_LUNAR_RIFT_MAX = "What in the blazes was that?",
    ANNOUNCE_SHADOW_RIFT_MAX = "What in Sam Hill was that?",

    ANNOUNCE_SCRAPBOOK_FULL = "I know just about everythin' I need to.",

    ANNOUNCE_CHAIR_ON_FIRE = "That there is fine.",
	...
	{	
        ...
        MOONROCKIDOL = "I ain't no stranger to offerin' somethin' up to space.",
        CONSTRUCTION_PLANS = "This here calls for precision engineering.",
		MOONROCKSEED = "I ain't meddlin' in that business.",
		ANTLION = 
		{
		...
		--Engineer items
		ESENTRY = "A heavy caliber, tripod-mounted, little ol' number designed by me... built by me...\n...and you'd best hope... not pointed at you.",
		DISPENSER = "This here Dispense-O-Matic 9000 Provisions Dispenser oughta keep us fully equipped with proper munitions.",
		ETELEPORTER = "We are riding high!",
		ETELEPORTER_EXIT = "Weren't no thing.",
		TF2WRENCH = "This wrench ain't gonna swing itself!",
		TF2WRENCHGOLDEN = "Guess I got the Midas touch!",
		GIBUS = "Not bad. Not bad at all.",
		EHARDHAT = "Ain't no hat harder than mine.",
		SCRAP = "Best use this before it rusts away.",
		DESTRUCTIONPDA = "Ain't no shame in fixin' what don't work.",
		...
		HOLY_MACKEREL = "You're all wore out.",
		...
		BALLOONPARTY = "I'll call that a Balloon Dispenser. Heh.",
		BALLOONSPEED =
        {
            DEFLATED = "Ain't it cute?",
            GENERIC = "Balloons are all about science. Even if they're a bit too pretty.",
        },
		BALLOONVEST = "Don't even wanna think about this being worn on the battlefield.",
		BALLOONHAT = "This has gotta be the least hardest hat I've ever seen.",
		WAXWELLJOURNAL =
		{
			GENERIC = "This ain't anything I'd like to master. Just ain't science.",
		...
		BOOKSTATION =
		{
			GENERIC = "Keeps your books from gettin' all outta sorts.",
			BURNT = "Ain't a pretty sight to lose all that knowledge.",
		},
		...
		BOOK_SILVICULTURE = "Not enough steel and refined metals for my area interest.",
		BOOK_HORTICULTURE = "If I ever need to garden, I oughta read this.",
        ...
        BOOK_FISH = "I'm pure Texan instinct, ma'am.",
        BOOK_FIRE = "Got that wood roasted book smell to it.",
        BOOK_WEB = "Ya wouldn't wanna get'cha nose all stuck in this'un.",
        BOOK_TEMPERATURE = "All the warmth of a Texan barbecue, none of the gut.",
        BOOK_LIGHT = "A little light readin' don't hurt none.",
        BOOK_RAIN = "Right as rain, that!",
        BOOK_MOON = "You ever drink a beer in the pale moonlight?",
        BOOK_BEES = "I ought to publish a book 'bout guns, that'll help ya somethin' good.",

        BOOK_HORTICULTURE_UPGRADED = "This'll keep your greenery growin' just right.",
        BOOK_RESEARCH_STATION = "A couple of PhDs later you won't need to re-read nothin'.",
        BOOK_LIGHT_UPGRADED = "Always wanted a bit of sun in my pockets!",

        FIREPEN = "Well I'll be! This pen might just be mightier than the sword!",
		...
		NESTING_WOOSE = "You always gotta start somewhere.", --woose specific
		--SW
		BOAT_SURFBOARD = "Ain't too hard! Just gotta know basic aerodynamics, how to calculate the tide, and wind speeds.",
		LUCKYHAT = "A little pirate engineering couldn't hurt. Not me at least.",
		LUCKYCUTLASS = "Nice blade for slicin'.",
		WOODLEGS_BURIEDTREASURE = "Anybody get any spare keys?",
		BOAT_WOODLEGS = "I ain't really the nautical type.",
		CANNON_WOODLEGS = "If it works, it's doin' its job.",
        ...
        PLAYER =
        {
			...
			FIRESTARTER = "Keep your hands off the campfire, %s!",
        },
		WILSON = 
		{
			GENERIC = "Howdy, %s.",
		...
		WOLFGANG = 
		{
			GENERIC = "Mornin', %s.",
			ATTACKER = "That %s's a spy!",
			MURDERER = "Gutless. We ought to knock you down a size.",
			REVIVER = "Nice job, %s.",
		...
		WAXWELL = 
		{
			...
			ATTACKER = "That %s's a spy!",
			MURDERER = "This skunk's startin' to smell.",
		...
		WX78 = 
		{
			...
			GHOST = "When ya meet your maker, tell 'em to build you some guts next time.",
		...
		WILLOW = 
		{
			GENERIC = "Howdy, %s.",
			ATTACKER = "That %s's a spy!",
			MURDERER = "All that fire won't protect you from some real firepower.",
			REVIVER = "Well done, %s.",
			GHOST = "Didn't your momma teach ya not to play with matches?",
			FIRESTARTER = "Don't tell me I'm gonna need to put out your campfire now.",
		},
		WENDY = 
		{
			GENERIC = "Mornin', %s.",
			ATTACKER = "That %s's a spy!",
			MURDERER = "Don't go doing anything hasty, little girl.",
			REVIVER = "I am damn proud right now!",
			GHOST = "Mourning on the battlefield ain't no way to be, %s.",
		...
		WOODIE = 
		{
			...
			REVIVER = "I believe I'd buy you a beer, %s! Heard Canada's got some fine maple beers.",
			...
			MOOSE = "Act up and you'll make a fine mantel piece, hoss.",
            MOOSEGHOST = "Looks like we got some fresh hide!",
            GOOSE = "You wouldn't happen to lay any golden eggs, now would ya?",
            GOOSEGHOST = "Quit ya squawkin'! I'm sure you'll respawn in no time.",
		...
		WICKERBOTTOM = 
		{
			GENERIC = "Howdy, Ms. %s.",
			ATTACKER = "That %s's a spy!",
			MURDERER = "Study all ya want, I know how to let my knowledge out the schematics!",
			REVIVER = "You wrangled that up just right, %s. How many PhDs ya got?",
			GHOST = "Sorry, ma'am. Let's get to fixin' up a heart!",
			FIRESTARTER = "I'd advise you to keep your torches away from my machines.",
		},
		WES = 
		{
			GENERIC = "Mornin', %s.",
			...
			FIRESTARTER = "Ya got a new line of make-up? Or is that charcoal, pardner?",
		},
		WEBBER = 
		{
			GENERIC = "Howdy, %s.",
			...
			REVIVER = "Kid's got a good head on 'em. If ya can look past the bug-bits.",
			GHOST = "How 'bout we rustle you up a heart?",
		...
		WATHGRITHR = 
		{
			...
			FIRESTARTER = "You're all show and no battle, hoss.",
		},
		WINONA = 
		{
			GENERIC = "Howdy, %s.",
			...
			REVIVER = "Might I pick ya brain on a few topics? Engines, pinion shafts, mitigating shock loads to name a few.",
			GHOST = "You just ain't doin' it right!",
			FIRESTARTER = "You got your wires-crossed, %s?",
		},
		WORTOX =
        {
            GENERIC = "Howdy, %s.",
			...
			FIRESTARTER = "That's why ya don't feed 'em after midnight.",
        },
		WORMWOOD =
        {
            GENERIC = "Howdy, %s.",
            ATTACKER = "That %s's a spy!",
            MURDERER = "Son, I got the water you're needin', we call 'em bullets in Texas.",
            REVIVER = "You wrangled that as right as your vines!",
            GHOST = "Speak up next time, boy!",
			FIRESTARTER = "You shouldn't be playing with fire, boy.",
        },
		WARLY =
        {
            GENERIC = "Mornin', %s.",
            ...
            REVIVER = "I believe I'd buy you a beer, %s!",
		...
		WURT =
        {
            GENERIC = "Howdy, %s.",
            ATTACKER = "That %s's a spy!",
            MURDERER = "If this is the mermfolk's best warrior, this oughta be easy.",
		...
		WALTER =
        {
            GENERIC = "Howdy, %s.",
            ATTACKER = "That %s's a spy!",
            MURDERER = "I've got double the badges in killin', son.",
		...
		WANDA =
        {
            GENERIC = "Mornin', %s.",
            ATTACKER = "That %s's a spy!",
            MURDERER = "Ma'am, bullets are gonna reach their destination one way or the other.",
            REVIVER = "Mighty fine bits of engineerin' you've thought up!",
            GHOST = "Fine lady you are. Dead now, but fine.",
            FIRESTARTER = "You're lettin' your teleporters leave some nasty trails.",
        },
        WONKEY =
        {
			GENERIC = "Greetin's, %s. I know you from somewhere?",
			ATTACKER = "That %s's a spy!",
			MURDERER = "You can hardly blame a monkey for murder, can ya?",
			REVIVER = "That monkey sure knows how to wrangle up a heart.",
			GHOST = "They ain't got the longest lifespan in the animal kingdom.",
			FIRESTARTER = "We best keep you away from fire now.",
        },
		WALANI = 
		{
			GENERIC = "Mornin', %s.",
			ATTACKER = "That %s's a spy!",
			MURDERER = "Can't be too bad, you're finally doin' some dirty work!",
			REVIVER = "We got along just fine.",
			GHOST = "Can't be restin' on your laurels now!",
			FIRESTARTER = "The ocean's that'a'way, ma'am.",
		},
		WILBUR = 
		{
			GENERIC = "Greetin's, %s.",
			ATTACKER = "That %s's a spy.",
			MURDERER = "You can hardly blame a monkey for murder, can ya?",
			REVIVER = "That monkey sure knows how to wrangle it up.",
			GHOST = "They ain't got the longest lifespan in the animal kingdom.",
			FIRESTARTER = "We best keep you away from fire now.",
		},
		WOODLEGS = 
		{
			GENERIC = "Howdy, %s.",
			ATTACKER = "That %s's a spy.",
			MURDERER = "You're a mercenary without the pay, %s.",
			REVIVER = "How 'bout we go get ourselves some fresh rum, %s?",
			GHOST = "That's why I get paid and you don't.",
			FIRESTARTER = "While you were busy fire fightin', I was gettin' educated.",
		},
		ENGINEER = 
        {
        ...
        {
	        GENERIC = "%s.",
	        ATTACKER = "That Spy ain't on our side!",
		...
		WEARGER =
        {
            GENERIC = "Howdy, %s.",
            ATTACKER = "That %s's a spy!",
            MURDERER = "We got bullets for bears where I come from.",
            REVIVER = "That badger sure can take a heart-to-heart well!",
            GHOST = "Must've mistook ya for the real thing, hoss!",
            FIRESTARTER = "This'un got a bit of a temper to 'em.",
        },
		WEERCLOPS =
        {
            GENERIC = "Greetin's, %s.",
            ATTACKER = "That %s's a spy!",
            MURDERER = "Not as fun to take down small.",
            REVIVER = "You're a might kinder than the other ones we've fought!",
            GHOST = "You walked right into that one, mumbles.",
            FIRESTARTER = "Guess you're gettin' tired of just usin' claws.",
        },
		WOOSE =
        {
            GENERIC = "Howdy, %s.",
            ATTACKER = "That %s's a spy!",
            MURDERER = "You ain't nobody's momma!",
            REVIVER = "You've got a real nice maternal heart somewhere in there.",
            GHOST = "Can't say I didn't see it comin'.",
            FIRESTARTER = "You've got a fire problem. Among some.",
        },
		WRAGONFLY =
        {
            GENERIC = "Greetin's, %s.",
            ATTACKER = "That %s's a spy!",
            MURDERER = "We all know how fairy-tales end. It ain't gonna be a pretty look on ya.",
            REVIVER = "Guess I owe that one to ya!",
            GHOST = "Boy howdy, guess I'm a dragon slayer!",
			ENRAGED = "What's got your sparks flyin'?",
            FIRESTARTER = "You're a little firefly, ain'tcha?",
        },

        MIGRATION_PORTAL = {
            GENERIC = "Pony up, boys.",--unimplemented
            OPEN = "Shucks, I was just getting started!",--unimplemented
            FULL = "There's no room for me in there.",--unimplemented
        },
		GLOMMER =
        {
            GENERIC = "I won't let my machines get'cha, lil' feller.",
            SLEEPING = "Almost makes ya want to tuck 'er in.",
        },
		GLOMMERFLOWER = 
		{
			GENERIC = "It's a might pretty.",
        ...
        WETPAPER = "Ain't fit for any dry schematics.",
        WETPOUCH = "Best hope nothing nasty crawled up in there.",
		...
		MOONDIAL = 
        {
			...
			GLASSED = "Don't think we're alone no more.",
        },
		...
		NIGHTMARE_TIMEPIECE =
		{
            ...
            WANING = "Magic's still runnin' hot, but won't last too long now.",
		...
		NIGHTMARELIGHT = "If I got the time, I oughta study this thing.",
		...
		SLURPER_PELT = "You ain't too fast for me and my machines now, are ya? Heh. Are ya?",
		...
		YELLOWGEM = "I'm gettin' some bright ideas from this here gem.",
        ...
        OPALPRECIOUSGEM = "Now that there's an opulent lil' gem!",
		TELEBASE = 
		{
			VALID = "It's ready.",
			GEMS = "Somebody wanna rustle up some purple-coated beauties my way?",
		},
		GEMSOCKET = 
		{
			VALID = "It's ready.",
		...
		STAFFCOLDLIGHT = "A little ball of winter to tug at'cha toes.",
	
        ANCIENT_ALTAR = "Some worship statue for a long gone god. You ever get what you were prayin'?",
		...
		CUTLICHEN = "Dry and crumbly, ain't the best feeling.",
		...
		GUANO = "Better under the boots than atop my sentry's hood. Ideally, eradicated.",
		LANTERN = "Ain't no mine without 'em.",
		...
		SLEEPBOMB = "Makes ya catch Zzz's somethin' fierce.",
		...
		SPIDERHOLE="Any Texan knows not to disturb a nest when ya see one.",
		...
		TURF_CARPETFLOOR = "We takin' our boots off before steppin' on it?",
		TURF_CHECKERFLOOR = "Don't get me started reminiscing on the diners back home.",
		...
		TURF_FUNGUS_MOON = "I'd rather be building machines, not dirt in my pockets.",
		TURF_ARCHIVE = "I'd rather be building machines, not dirt in my pockets.",
		TURF_SINKHOLE="Ain't my first choice of dirt to walk on.",
		TURF_UNDERROCK="Nothin' fancy 'bout steppin' stones.",
		...
		TURF_SHELLBEACH = "I ain't fancy sand up in my boots.",

		TURF_RUINSBRICK = "Looks like it's best to be stepped on.",
		TURF_RUINSBRICK_GLOW = "Looks like it's best to be stepped on.",
		TURF_RUINSTILES = "Looks like it's best to be stepped on.",
		TURF_RUINSTILES_GLOW = "Looks like it's best to be stepped on.",
		TURF_RUINSTRIM = "Looks like it's best to be stepped on.",
		TURF_RUINSTRIM_GLOW = "Looks like it's best to be stepped on.",

        TURF_MONKEY_GROUND = "It ain't like it's not been stepped on before.",

        TURF_CARPETFLOOR2 = "We takin' our boots off before steppin' on it?",
        TURF_MOSAIC_GREY = "That's what it was made for.",
        TURF_MOSAIC_RED = "That's what it was made for.",
        TURF_MOSAIC_BLUE = "That's what it was made for.",

        TURF_BEARD_RUG = "That there's a sign of good barbery.",
        ...
        CAVE_ENTRANCE_OPEN = {
            GENERIC = "Grrrrr....",
            OPEN = "Move 'em out!",
            FULL = "They got a heavy load down there.",
        },
        CAVE_EXIT = {
            GENERIC = "Guess I'll come back another day.",
		...
		ADVENTURE_PORTAL = "The way this door functions has me reconsiderin' my current knowledge of psychics.",
		AMULET = "Makes me feel as fit as a fiddle!",
		ANIMAL_TRACK = "It must itchin' for me to hunt it.",
		ARMORGRASS = "It's as comfortable as it is protective. So not much.",
		ARMORMARBLE = "I've lifted heavier toolboxes in my day.",
		...
		BABYBEEFALO = 
		{
		    ...
		    SLEEPING = "The lil' thing is sleepin'.",
        },
		...
		BASALT = "No matter how much ya hit it, it ain't budgin'.",--removed
		BEARDHAIR = "These foul chin clippin's ain't mine.",
		BEARGER = "I've got bullets for bears back home, boy!",
		BEARGERVEST = "Keeps ya all nice 'n snug like.",
		ICEPACK = "Keeps the food nice and insulated.",
		BEARGER_FUR = "This here pile of thick fur oughta keep you warm by just touchin' it.",
		BEDROLL_STRAW = "Much like the hay bails back home!",
		BEEQUEEN = "Monarchy is such an antiquated system of social governance.",
		BEEQUEENHIVE = 
		{
			GENERIC = "Best not to get all that under my boots.",
			GROWING = "Looks like the bees are fixin' to get mean.",
		},
        BEEQUEENHIVEGROWN = "Now I ain't plannin' on swingin' wrenches at nests.",
        BEEGUARD = "If ya willin' to die for your queen, your day's come!",
		HIVEHAT = "This'll have 'em rollin' out the red carpet for ya boots.",
		MINISIGN =
        {
		...
		BEEBOX =
		{
			READY = "How 'bout I grill us up some honey-glazed steaks!",
			FULLHONEY = "Sweet honey, come home!",
			GENERIC = "It's one way to store ya bees.",
			NOHONEY = "Ain't no honey here.",
			SOMEHONEY = "We oughta be gettin' some more shortly.",
		...
		BEEFALO =
		{
			...
			MYPARTNER = "Who's Engie's favorite little cattle? Might'n guess?",
		},
		BEEFALOHAT = "Not bad. Not bad at all.",
		BEEFALOWOOL = "Hope it don't got no weevils hidin' in it.",
		BEEHAT = "A bee-keeper's hat without the suit.",
		BEESWAX = "Reminds me of home.",
		BEEHIVE = "You can hear the buzzin' from here to Texas!.",
		BEEMINE = "They're very angry in there. Heh.",
		BEEMINE_MAXWELL = "Angry little buggers are eager to get a taste of my blood.",--removed
		BERRIES = "Well, I guess these'll do.",
		BERRIES_COOKED = "They seem the same, just melded together.",
		BERRIES_JUICY = "Best eat 'em quickly.",
        BERRIES_JUICY_COOKED = "I oughta keep these close.",
		BERRYBUSH =
		{
			...
			DISEASED = "That thing's lookin' sick.",--removed
			DISEASING = "That there bush is dwindling.",--removed
		...
		BIGFOOT = "Keep clear from its path!",--removed
		BIRDCAGE =
		{
		...
		BLUEGEM = "If I didn't know any better, I'd say this were the work of an enemy.",
		BLUEPRINT = 
		{ 
		...
		COOKINGRECIPECARD = 
		{
			GENERIC = "Here I was thinkin' we engineers had it rough writin'!",
		},
		BLUE_CAP = "It seems mildly poisonous.",
		BLUE_CAP_COOKED = "Looks like its more unsavory aspects done got cooked down.",
		BLUE_MUSHROOM =
		{
        ...
        SHADOWDANCER = "Now that's a dance I can get behind!",
		...
		WATERMELON_SEEDS = "For plantin' somethin'.",
        ...
        CHESSPIECE_FORMAL = "That there is a sad display, boy.",
        CHESSPIECE_HORNUCOPIA = "We got the cornucopia, now where's the meal?",
        CHESSPIECE_PIPE = "Can't smoke that thing.",
        CHESSPIECE_DEERCLOPS = "The victors write the books, pardner.",
        ...
        CHESSPIECE_MOON = "The sculpt in the sky is a sight prettier.",
        ...
        CHESSPIECE_ANTLION = "Ain'tcha love it when we can brag?",
		CHESSPIECE_BEEFALO = "All stone, no cattle.",
		CHESSPIECE_KITCOON = "Lot less hairs on the overalls this way.",
		CHESSPIECE_CATCOON = "Look what the cat done dragged in!",
        CHESSPIECE_MANRABBIT = "Heh. What'll they be sculptin' next.",
        CHESSPIECE_GUARDIANPHASE3 = "Best keep it this way.",
		CHESSPIECE_EYEOFTERROR = "Less of an eye sore now ain't ya?",
        CHESSPIECE_TWINSOFTERROR = "That's one way to reap a reward.",
		CHESSPIECE_DAYWALKER = "Sculptor must'a been feelin' mighty generous.",
        CHESSPIECE_DEERCLOPS_MUTATED = "I had hoped for a challenge with that one!",
        CHESSPIECE_WARG_MUTATED = "Wouldya lookit that! We won.",
        CHESSPIECE_BEARGER_MUTATED = "The dead look a sight better wall-mounted than puppeted.",
		...
		CHESTER = "You're a comfortin' sight out here in the sticks, pardner.",
		CHESTER_EYEBONE =
		{
			GENERIC = "What'cha starin' at?",
			WAITING = "It's takin' a nap. That or it's dead.",
		},
		COOKEDMANDRAKE = "Your delicious sacrifice will be remembered by my stomach, son.",
		...
		CORN_SEEDS = "Strange seeds.",
		CANARY =
		{
			GENERIC = "You like keeping watch? Watch my machines and keep an eye out for any turncoats.",
        ...
        CRITTER_DRAGONLING = "That's one spicy critter.",
		...
		CROW =
		{
			GENERIC = "You oughta stand back a little more, like from me and my machines.",
			HELD = "Gotcha, corvus!",
		},
		CUTGRASS = "Cuttins ready for makin' things.",
		CUTREEDS = "Reed cuttins ready for makin' things.",
		CUTSTONE = "Some fine buildin' materiel right here.",
		DEADLYFEAST = "That's one killer dish.",--unimplemented
		DEER = 
		{
        ...
        DEER_GEMMED = "Feller's being controlled like a puppet, no strings attached.",
        ...
        DESERTHAT = "My goggles ain't much for dirt blockin'.",
        ANTLIONHAT = "Gotta move that ground up!",
		DEVTOOL = "Its got a meaty smell to it.",
		DEVTOOL_NODEV = "Didn't want to wield it anyhow.",
		...
		DRAGONFLY = "Avarice is a vice that consumes the heart of men. And dragons. Seems like flies too.",
		ARMORDRAGONFLY = "This oughta keep ya nice and protected.",
		DRAGON_SCALES = "Blowin' on it sure ain't coolin' nothin' down.",
		DRAGONFLYCHEST = "Just try meddlin' in my business now!",
		DRAGONFLYFURNACE = 
		{
			HAMMERED = "Now that there is just a sad display, boy.",
			GENERIC = "It has heat, but not too much light.", --no gems
			NORMAL = "Must be high noon!", --one gem
			HIGH = "This contraptions runnin' red hot!", --two gems
		},

        HUTCH = "Lets me take a load off by holdin' onto the lesser important parts.",
        HUTCH_FISHBOWL =
        {
		...
		LAVAE_PET = 
		{
			...
			GENERIC = "Beast been tamed.",
		},
		LAVAE_EGG = 
		{
			GENERIC = "Got all the warmth of a mother's hug tucked inside.",
		},
		LAVAE_EGG_CRACKED =
		{
			COLD = "Ain't gettin' much heat over there!",
			COMFY = "I'm thinkin' it's one happy camper.",
		},
		LAVAE_TOOTH = "Now which one came first?",
		...
		DUG_GRASS = "It'd be happier in the ground now.",
		DUG_MARSH_BUSH = "There's a less of a chance of it poking me in the ground.",
		DUG_SAPLING = "This little tree needs a dirt home.",
		DURIAN = "Whew! This thing smells foul!",
		DURIAN_COOKED = "You ain't doin' my nose any favors! Whew!",
		DURIAN_SEEDS = "Seeds with a plant to boot.",
		EARMUFFSHAT = "Keep your ears warmed with this.",
		EGGPLANT = "A good ol'reliable eggplant.",
		EGGPLANT_COOKED = "Both reliable and broiled.",
		EGGPLANT_SEEDS = "Seeds for somethin'.",
		
		ENDTABLE = 
		{
			BURNT = "That opulent appearance was all illusion.",
			GENERIC = "Havin' a fixer-upper don't hurt none.",
			EMPTY = "Oughta fix it up somethin' pretty.",
			WILTED = "That plant ain't feelin' too well.",
			FRESHLIGHT = "Mighty fine to have some table light 'round here.",
			OLDLIGHT = "Light's feelin' a might antiquated.",
		},
		DECIDUOUSTREE = 
		{
			BURNING = "Tree's burnin' down.",
			BURNT = "Well now that is a shame.",
			CHOPPED = "Nice work.",
			POISON = "You comin' back for seconds, pardner?",
			GENERIC = "I got schematics for wood choppin', might'n up and use 'em!",
		},
		ACORN = "This ought to be the toughest nut I've seen.",
        ACORN_SAPLING = "Tree ain't been planted can't get chopped.",
		ACORN_COOKED = "A might more edible, for what it's worth.",
		BIRCHNUTDRAKE = "Now someone ain't a happy camper.",
		EVERGREEN =
		{
			BURNING = "Tree's burnin' up!",
		...
		TWIGGYTREE = 
		{
			...
			CHOPPED = "Weren't no thing.",
			GENERIC = "That's a mighty fine amount of twigs ya got, pardner.",			
			DISEASED = "Poor little thing.",
		},
	    TWIGGY_NUT_SAPLING = "Now that there's pretty pathetic for a tree.",
        TWIGGY_OLD = "I ain't able to muster up much of a use for it.",
		TWIGGY_NUT = "Twigs got to come from somewhere.",
		EYEPLANT = "Didn't anyone teach ya not to stare?",
		INSPECTSELF = "That there's yours truly.",
		FARMPLOT =
		{
			GENERIC = "Bit of an empty plot, ain't it?",
			GROWING = "Get growin'!",
		...
		FEATHER_CROW = "Nice little feather.",
		FEATHER_ROBIN = "Plucked ya, hoss.",
		...
		COOKBOOK = "I drop my steaks on the grill and magic happens on its own!",
		FEM_PUPPET = "That there is just a sad display, ma'am.",
		FIREFLIES =
		{
		...
		COLDFIREPIT =
		{
			...
			HIGH = "That's what it was made for.",
			LOW = "The fire's runnin' low.",
			NORMAL = "That's a cool breeze.",
			OUT = "Ain't cold without a light.",
		},
		...
		FOLIAGE = "The foliage down here looks a might unusual.",
		FOOTBALLHAT = "I got hats harder than this.",
		FOSSIL_PIECE = "I ain't no archaeologist, but I'll see what I can muster up.",
        FOSSIL_STALKER =
        {
        ...
        STALKER_MINION = "How 'bout I introduce ya to the underside of my boot, boy?",
		THURIBLE = "Smells like a machine runnin' hot.",
        ATRIUM_OVERGROWTH = "Looks like some ancient language I ain't got time to decipher.",
		FROG =
		{
			DEAD = "Frog's a goner.",
		...
		FROGGLEBUNWICH = "That probably don't got the greatest of flavor palettes.",
		FROGLEGS = "Some folk might like 'em raw.",
		FROGLEGS_COOKED = "Looks like legends do come true.",
		FRUITMEDLEY = "A nice cup of fruits, that.",
		FURTUFT = "That beast sure ain't missin' it.", 
		GEARS = "Can't work without 'em.",
		GHOST = "You got bets to settle, buzzard bait?",
		GOLDENAXE = "Best hope the trees don't go gold with this.",
		...
		GREEN_CAP = "Don't need no foraging guide to tell me this one'll do ya in.",
		GREEN_CAP_COOKED = "Looks a sight more edible now.",
		GREEN_MUSHROOM =
		{
		...
		GUNPOWDER = "Yeehaw! Now we're gettin' somewhere! Grab my schematics, we're fixin' up some guns!",
		...
		HEATROCK =
		{
			...
			COLD = "It's startin' to tug at my fingertips.",
			GENERIC = "Manipulate its temperature to whatever helps.",
			WARM = "Ya might catch me dozin' off a little.",
			HOT = "Feelin' the burn now!",
		},
		HOME = "Someone must be livin' there.",
		HOMESIGN =
		{
			GENERIC = "A sure sign of somethin'.",
            UNWRITTEN = "Ain't been written on.",
			BURNT = "Must've been important, or not at all.",
		},
		ARROWSIGN_POST =
		{
			GENERIC = "Points as much.",
            UNWRITTEN = "Ain't been written on.",
		...
		JAMMYPRESERVES = "A fine bit of Texan toast and you got yourself a grade A breakfast!",

		KABOBS = "Hardly see a proper barbecue without 'em!",
		KILLERBEE =
		{
		...
		LIGHTNINGGOAT = 
		{
			GENERIC = "All that grazing's gonna get'cha killed.",
			CHARGED = "Critter's fixin' to get mean!",
		},
		LIGHTNINGGOATHORN = "A mini lightning rod oughta do me well.",
		GOATMILK = "It's more electric than usual.",
		LITTLE_WALRUS = "Like father, like son. Pure ugly.",
		LIVINGLOG = "It seems frightened. You got somethin' to say, boy?",
		LOG =
		{
			BURNING = "Might've over-logged that one.",
			GENERIC = "It's best used to make things.",
		},
		...
		MANDRAKE = "It ain't peepin' no longer.",

		MANDRAKESOUP = "'Pologies, little feller.",
		MANDRAKE_COOKED = "Mm-Mm! Smells better than I would'a guessed!",
	    MAPSCROLL = "It ain't all too useful blank.",
		MARBLE = "Got a nice sculpt to it.",
		MARBLEBEAN = "You wouldn't happen to be magic, would ya?",
		MARBLEBEAN_SAPLING = "That's somethin' new. How big's it grow?",
        MARBLESHRUB = "Well I'll be. Must be how the Romans felt!",
		MARBLEPILLAR = "Ain't that a beauty.",
		MARBLETREE = "What's the point of makin' a marble tree?",
		MARSH_BUSH =
		{
			BURNING = "Figures that answers any burning questions ya had.",
			GENERIC = "That's one sharp lookin' plant.",
			PICKED = "Really sticks to ya good.",
		},
		BURNT_MARSH_BUSH = "Spiky and crumbly.",
		MARSH_PLANT = "I ain't no biological engineer, but I figure that there's a simple plant.",
		MARSH_TREE =
		{
			BURNING = "Burnin' something fierce.",
			BURNT = "You done and spooked me a little.",
			CHOPPED = "Choppin' that weren't nothing.",
			GENERIC = "Ain't you just the sharpest tool in this shed.",
		},
		MAXWELL = "Oh, ya yellow-bellied gutless coward!",--single player
		MAXWELLHEAD = "Even uglier up close.",--removed
		...
		MEATRACK =
		{
			...
			DRYINGINRAIN = "The rain ain't doin' us any favors.",
            ...
            DRYINGINRAIN_NOTMEAT = "The rain ain't doin' us any favors.",
		},
		...
		MINERHAT = "If I had wanted a light, I oughta engineer somethin' up on the hat I got.",
		MONKEY = "Ain't you a curious little feller.",
		MONKEYBARREL = "Can't say I like what I'm smellin'!",
        ...
        MINIFAN = "A lil' pocket fan made of twigs.",
		GOOSE_FEATHER = "You sure it's legal to pick 'em up and take 'er home?",
		STAFF_TORNADO = "This oughta bring storms down upon my enemies somethin' fierce.",
		MOSQUITO =
		{
			GENERIC = "You take the blood, you take the bullet.",
			HELD = "I reckon you don't try and suck my blood next time, leech.",
		},
		MOSQUITOSACK = "If it ain't someone else's blood it's mine.",
		MOUND =
		{
			DUG = "Sorry, pardner.",
			GENERIC = "Aw, shucks. Who was it this go 'round?",
		},
		...
		OASISLAKE = 
		{
			GENERIC = "I sure hope I ain't just seein' things.",
			EMPTY = "That there's just an over-sized sand box.",
		},
		PANDORASCHEST = "Content may vary.",
		PANFLUTE = "To go on and get thing's to sleep.",
		PAPYRUS = "Some thin paper sheets, good for writin' down schematics.",
		WAXPAPER = "Some waxed paper sheets, pretty protective.",
		PENGUIN = "Why don't you all get along before one of you gets hurt.",
		PERD = "You best get your own berries. Gutless.",
		PEROGIES = "Seems like a mighty fine source of nutrition.",
		PETALS = "Plucked little petals of a flower.",
		PETALS_EVIL = "These petals are somethin' mean.",
		PHLEGM = "Eugh. Don't touch that darn thing.",
		PICKAXE = "Looks like I'm headin' to the mines.",
		...
		PIGKING = "Now that there is a sad display, pork drippings.",
		PIGMAN =
		{
			DEAD = "Like a hog to slaughter!",
		...
		POMEGRANATE_SEEDS = "Seeds belonging to somethin'.",
		...
		PUMPKIN_LANTERN = "Reminds me of some good holiday times. 'Course there were the bombs.",
		PUMPKIN_SEEDS = "Lil' seeds, harmless.",
		PURPLEAMULET = "Makes me feel insane by only touchin' it.",
		PURPLEGEM = "It's quite the sight. Could think up a few good uses for its essence.",
		RABBIT =
		{
		...
		RAINOMETER = 
		{	
			GENERIC = "It measures the clouds. Ain't too sure how useful that'll be.",
			BURNT = "Guess it got too hot for ya. I could'a told ya that one.",
		},
		...
		REDGEM = "I got some mighty big plans for you, lil' gem.",
		RED_CAP = "This one seems pretty poisonous.",
		RED_CAP_COOKED = "Don't need no foraging guide to know it's been grilled.",
		RED_MUSHROOM =
		{
		...
		ROCK_LIGHT =
		{
			GENERIC = "A crusted over pit of lava.",--removed
			OUT = "Looks weak.",--removed
			LOW = "The lava's crustin' over.",--removed
			NORMAL = "Nice and bright.",--removed
		},
		CAVEIN_BOULDER =
        {
		...
		SAPLING =
		{
			...
			DISEASED = "That there plant is near death.",--removed
			DISEASING = "Poor lil' plant, I oughta try and nurse it back to health.",--removed
		},
		SCARECROW = 
   		{
		...
		SKULLCHEST = "Death's waitin' 'round here.", --removed
		SMALLBIRD =
		{
		...
		SPIDER =
		{
			DEAD = "Your sneaky behind just got beat like a mule, son!",
		...
		SPIDERGLAND = "Smells more bland than gland.",
		...
		STAGEHAND =
        {
			...
			HIDING = "That just ain't sittin' right with me.",
        },
		STATUE_MARBLE = 
        {
		...
		TREECLUMP = "It ain't lettin' me through.",--removed
		...
		TRINKET_24 = "Ain't lucky no more.",
		...
		TRINKET_38 = "These lens ain't good for lookin', and they ain't good lookin' neither!", -- Binoculars Griftlands trinket
        TRINKET_39 = "I like my lone gloves too, I'll give ya that.", -- Lone Glove Griftlands trinket
        ...
        TRINKET_44 = "Just missed it past its prime.", -- Broken Terrarium ONI trinket
        TRINKET_45 = "Ain't gettin' any frequencies here.", -- Odd Radio ONI trinket
        TRINKET_46 = "I ought to use this. Had I the hair for it, 'course.", -- Hairdryer ONI trinket
        ...
        HALLOWEENCANDY_3 = "I'll take one'a these on my plate any day!",
        HALLOWEENCANDY_4 = "Can't say it's makin' the mouth water.",
        ...
        HALLOWEENPOTION_DRINKS_WEAK = "You got the wrong Engineer if you think I can't handle no weak drink!",
		...
		HALLOWEENPOTION_MOON = "A bit outta my realm of engineering, that.",
        ...
        LUCKY_GOLDNUGGET = "Looks like my luck's taken a turn.",
        FIRECRACKERS = "Cracklin'!",
        PERDFAN = "I reckon that's a fine breeze.",
		...
		CARRAT_GHOSTRACER = "You ain't cheating now, are ya?",
        ...
        {
            GENERIC = "Looks like it's lookin' for blood.",
            EMPTY = "It'd be best put with some cattle parts.",
            BURNT = "Darn.",
        },

        BEEFALO_GROOMER =
        {
            GENERIC = "Well, I ain't groomin' my hair no time soon.",
            OCCUPIED = "How 'bout we doll you up?",
            BURNT = "Now that's why I stick to my lane of engineering.",
        },
        BEEFALO_GROOMER_ITEM = "Could go up places.",

        YOTR_RABBITSHRINE =
        {
            GENERIC = "Looks like it's lookin' for snack.",
            EMPTY = "It'd be best put with some grub.",
            BURNT = "Darn.",
        },

        NIGHTCAPHAT = "Heh! Snug as a bug in a bear skin rug!",

        YOTR_FOOD1 = "I always got room for dessert.",
        YOTR_FOOD2 = "Ain't ever thought how'd the moon taste. Guess I'll keep wonderin'!",
        YOTR_FOOD3 = "Odd little treat, that.",
        YOTR_FOOD4 = "Got a soft spot for the skewered.",

        YOTR_TOKEN = "How 'bout I give you a hand?",

        COZY_BUNNYMAN = "Got nothin' but stuffin' in those ears.",

        HANDPILLOW_BEEFALOWOOL = "Now that there's a pillow fit for a bed!",
        HANDPILLOW_KELP = "Can't imagine that's good for dreams.",
        HANDPILLOW_PETALS = "That'll have ya neck achin' in the mornin'!",
        HANDPILLOW_STEELWOOL = "Maybe one'a my machines would fancy it.",

        BODYPILLOW_BEEFALOWOOL = "Now that there's a pillow fit for a bed!",
        BODYPILLOW_KELP = "Can't imagine that's good for dreams.",
        BODYPILLOW_PETALS = "That'll have ya neck achin' in the mornin'!",
        BODYPILLOW_STEELWOOL = "Maybe one'a my machines would fancy it.",
		...
		TRUNK_SUMMER = "Ain't seen a trunk quite as breezy.",
		TRUNK_WINTER = "Nice bit of fur I got myself here.",
		TUMBLEWEED = "Must be high noon.",
		...
		WALL_DREADSTONE = "Well, don't hear the cattle complaining.",
		WALL_DREADSTONE_ITEM = "Let's get to layin' out these schematics.",
		...
		WALRUSHAT = "Think it comes in a fine picnic plaid?",
		WALRUS_CAMP =
		{
		...
		WARG = "You're one angry doggie, aint'tcha?",
		WARGLET = "Must be like the coyotes back home! Just gotta scare 'em away.",
		...
		WATERMELON_COOKED = "Can't say I grilled a melon back home. Can't say I'm complainin'!",
		WATERMELONHAT = "Not the kinda hard hat I find my self wearin'...",
        ...
        WINTER_TREESTAND = "Now, why don't we get some festivity goin'?",
        WINTER_ORNAMENT = "Nobody's above decorating a lil' tree now and then.",
        WINTER_ORNAMENTLIGHT = "Little bit of electricity goes a long way.",
		WINTER_ORNAMENTBOSS = "Let's get you atop our tree, hoss.",
		WINTER_ORNAMENTFORGE = "Looks beaten to a pulp.",
		WINTER_ORNAMENTGORGE = "Reminds me of grillin'. Couldn't tell ya why.",
        
        WINTER_FOOD1 = "You ready for death you've earned in my gullet, little man?", --gingerbread cookie
		...
		WINTER_FOOD5 = "That there's what festivities are all about! Good eatin'!", --yule log cake
        WINTER_FOOD6 = "Now how could ya hate somethin' like this?", --plum pudding
        WINTER_FOOD7 = "Now that's somethin' to relish.", --apple cider
        WINTER_FOOD8 = "Ain't no one above drinkin' one of these on a winter night.", --hot cocoa
        WINTER_FOOD9 = "A splash of my favorite elixir and you got my favorite holiday drink.", --eggnog
		...
		GRAVY = "Cream gravy!!",
		LATKES = "I'll be sure to send these on their way to my gullet!",
		...
		PICKLEDHERRING = "Got myself into a little pickle here!",
		POLISHCOOKIE = "Gotta move these into my mouth!",
		PUMPKINPIE = "Smellin' sweeter each sniff! Got my mouth watering somethin' fierce!",
        ...
        KLAUS = "You're gonna be needin' a lot more stitches after this, hoss!",
        KLAUS_SACK = "Somethin' unusual or strange may be hidin' in there.",
		KLAUSSACKKEY = "Must be for a big n' mean crate.",
		WORMHOLE =
		{
			GENERIC = "Don't look all too pleasin' to the eye.",
		...
		REVIVER = "We ain't got time to die!",
		SHADOWHEART = "That there's the heart of a backstabber, boys.",
		ATRIUM_RUBBLE = 
        {
		...
		LIFEINJECTOR = "Now that's some smart thinkin'.",
		SKELETON_PLAYER =
		{
   	...
   	--[[	LAVAARENA_ARMORLIGHT = "Light, but not very durable.",
        ...
        QUAGMIRE_TURNIP_SEEDS = "Bullets for the ground.",
        ...
        QUAGMIRE_FLOUR = "Gunpowder for things a might tastier than artillery.",
		...
		QUAGMIRE_CRABMEAT = "Lets get this fine piece of meat on a grill, how 'bout?",
		QUAGMIRE_CRABMEAT_COOKED = "Don't'cha just wanna grill?",
		QUAGMIRE_SUGARWOODTREE = 
		{
			GENERIC = "We oughta get some sap right about now.",
			STUMP = "Stumped.",
			TAPPED_EMPTY = "How 'bout a beer to pass the time, fellas?",
		...
		QUAGMIRE_SAFE = 
		{
			GENERIC = "Mighty preferable to a crate, I'll tell ya that much.",
		...
		QUAGMIRE_MUSHROOMS = "Battered and fried and I might give 'em a go!",
        QUAGMIRE_MEALINGSTONE = "Ain't much different to grinding out some fine metal!",
        ...
        QUAGMIRE_SWAMPIGELDER =
        {
            ...
            SLEEPING = "I'd love a good night's rest right 'bout now. Who's with me?",
        },
        QUAGMIRE_SWAMPIG = "They're a might hairier where I come from.",
        
        QUAGMIRE_PORTAL = "This ain't the right spawn point, is it.",
        QUAGMIRE_SALTROCK = "Add some flavor.",
        QUAGMIRE_SALT = "Add some flavor.",
        --food--
        QUAGMIRE_FOOD_BURNT = "We best take a class in culinary in a big damn hurry!",
        QUAGMIRE_FOOD =
        {
        ...
        QUAGMIRE_GOATMILK = "Milk's milk! A little calcium don't hurt none.",
        ...
        QUAGMIRE_GRILL = "We gotta feed a Gnaw? I just wanna grill for god's sake!",
        ...
        QUAGMIRE_PARK_GATE =
        {
            ...
            LOCKED = "We ain't gettin' in yet. We got a point to capture?",
        },
        ...
        WINONA_CATAPULT = 
        {
        	...
        	BURNT = "Shucks. No Engineer likes to see their hard work go up'n flames.",
        },
        WINONA_SPOTLIGHT = 
        {
        	GENERIC = "Whoo! Not bad! You taking suggestions?",
        	OFF = "Needs some power. And a bit of practical engineering.",
        	BURNING = "A poor worker blames their tools.",
        	BURNT = "Might wanna tone down the bulb on the next iteration.",
        },
        WINONA_BATTERY_LOW = 
        {
        ...
        WINONA_BATTERY_HIGH = 
        {
        	...
        	LOWPOWER = "Power's depleting. How 'bout I touch it up now?",
        	OFF = "Needs gems. Needs guns too.",
        	BURNING = "Ought to be more careful next time!",
        	BURNT = "Next time, how 'bout you pair it up with some precision-machined steel!",
        },
        --Wormwood
        COMPOSTWRAP = "That there's all fiber and then some.",
        ...
        PORTABLESPICER_ITEM =
        {
            ...
            DONE = "Things are just heatin' up!",
        },
        SPICEPACK = "'Bout time we got our fridges runnin' 'round here!",
        SPICE_GARLIC = "Whoo! That's the stench of everything good!",
        ...
        MONSTERTARTARE = "A bit too monstrous for my brunchin'.",
        FRESHFRUITCREPES = "Smells like somethin' back home!",
        FROGFISHBOWL = "Bits from the swamp down south.",
        ...
        VOLTGOATJELLY = "Whew! Sparkly! I ain't no stranger to gelatin!",
        ...
        MOQUECA = "Like a well full'a soup. And mushrooms. But still got no bullets.",
        GAZPACHO = "Goes right through ya.",
        ASPARAGUSSOUP = "Ain't the best soup I could'a mustered up.",
        VEGSTINGER = "Mm-mm! Spicy!",
        BANANAPOP = "Well, don't that beat all?",
        CEVICHE = "Better than any old mercenary rations.",
        ...
        TURNIP_SEEDS = "Bullets for the ground.",
        GARLIC = "Gotta say, they're right about it makin' things taste good!",
        GARLIC_COOKED = "Stronger smell than ever. Taste best match that.",
        ...
        ASPARAGUS = "Now, how can we be so sure what we're seein' is asparagus?",
        ASPARAGUS_COOKED = "Got that vegetable stench to it.",
        ASPARAGUS_SEEDS = "Fit for the ground.",
        PEPPER = "Ain't no spice I can't take!",
        PEPPER_COOKED = "Still ain't hotter than the Texas heat.",
        PEPPER_SEEDS = "Seeds that ain't got no ground.",
        ...
        FISHINGNET = "Capture up some sea goods.", --unimplemented
        ANTCHOVIES = "Mm! Now get me some Texan-styled pizza!", --unimplemented
        ...
        DRIFTWOOD_LOG = "It floats. Ain't much to ask of it.",
        ...
        MOON_TREE = 
        {
            ...
            GENERIC = "Ain't fancy trees like that back home. Wouldn't have guessed on the moon neither.",
        },
		...
		MOONBUTTERFLYWINGS = "You ain't flyin' no more.",
        ...
        DEAD_SEA_BONES = "Look like something up and died.",
        HOTSPRING = 
        {
        ...
        SPIDER_MOON = 
        {
        	GENERIC = "Come on, boys! This bug bait is all hat and no battle!",
        	SLEEPING = "Sleepin' off bullets won't do ya much.",
        	DEAD = "Nothin' good was lost.",
        },
        MOONSPIDERDEN = "Looks like I got some questions for my astrology teacher.",
		FRUITDRAGON =
		{
        ...
        PUFFIN =
        {
            ...
            HELD = "Not sure why but he's all mine now.",
        ...
        ICEBERG =
        {
            GENERIC = "We ought to avoid that.",--unimplemented
            MELTED = "All melted, nothin' to worry about.",--unimplemented
        },
        ICEBERG_MELTED = "All melted, nothin' to worry about.",--unimplemented

        MINIFLARE = "Lets me shoot some flares. Mighty useful.",
		MEGAFLARE = "Let's set up a rodeo heard all 'round Texas!",
		MOON_FISSURE = 
		{
		...
		MOON_ALTAR_ASTRAL = "Always a sight to see somethin' come together.",
        MOON_ALTAR_ICON = "I oughta know where this cog belongs.",
        MOON_ALTAR_WARD = "Let's set you up right.",
		...
		BOAT_GRASS_ITEM = "I'm no stranger to makin' smaller, more efficient variants.",
		...
		GESTALT_GUARD = "Don't think bullets will do this ghost in.",
        WALKINGPLANK = "That there's made for walkin' and sinkin'.",
        WALKINGPLANK_GRASS = "That there's made for walkin' and sinkin'.",
        OAR = "You all best get those arm muscle gears turnin', boys!",
		OAR_DRIFTWOOD = "Grease up those arms of yours and get rowin', boys!",

		OCEANFISHINGROD = "For some reel big practical problems.",
		OCEANFISHINGBOBBER_NONE = "Best put with a bobber.",
        OCEANFISHINGBOBBER_BALL = "Y'know, I oughta make a fishin' machine.",
        OCEANFISHINGBOBBER_OVAL = "Guess that'll do.",
		...
		OCEANFISHINGBOBBER_MALBATROSS = "Bet it floats. And if it don't float, use more gun.",
		...
		OCEANFISHINGLURE_HERMIT_HEAVY = "Y'all might wanna stand back. This'll be a mighty catch.",
        ...
        OCEANFISH_SMALL_9 = "Think you can out-spit a Texan, stretch?",
		...
		OCEANFISH_MEDIUM_9 = "Now aren't you just the sweetest lil' fish?",
		...
		TROPHYSCALE_FISH =
		{
			...
			BURNING = "Don't think even Pyro was this petty.",
		...
		SEAFOODGUMBO = "Good for the gullet.",
        ...
        WOBSTER_MOONGLASS = "Lil' sea bug's been dressed up all fancy like.",
        ...
        PORTABLETENT_ITEM = "Now when was the last time I set up one'a these?",
		 -- Wigfrid
        BATTLESONG_DURABILITY = "I ain't the singin' type. Just strummin'.",
        BATTLESONG_HEALTHGAIN = "I ain't the singin' type. Just strummin'.",
        BATTLESONG_SANITYGAIN = "I ain't the singin' type. Just strummin'.",
        BATTLESONG_SANITYAURA = "I ain't the singin' type. Just strummin'.",
        BATTLESONG_FIRERESISTANCE = "I ain't the singin' type.",
        BATTLESONG_INSTANT_TAUNT = "I don't think I got the best way with words.",
        BATTLESONG_INSTANT_PANIC = "I don't think I got the best way with words.",

        -- Webber
        MUTATOR_WARRIOR = "Ain't that cute.",
        MUTATOR_DROPPER = "Did a good job on these, son. Now look behind ya real quick would ya?",
        MUTATOR_HIDER = "Ain't that cute.",
        MUTATOR_SPITTER = "Did a good job on these, son. Now look behind ya real quick would ya?",
        MUTATOR_MOON = "Ain't that cute.",
        MUTATOR_HEALER = "Did a good job on these, son. Now look behind ya real quick would ya?",
        SPIDER_WHISTLE = "Could go for some shootin' practice.",
        SPIDERDEN_BEDAZZLER = "Hey now, it's a might closer to an engineering degree!",
        SPIDER_HEALER = "Gonna have to target this one with some clean bullets.",
        SPIDER_REPELLENT = "My natural Texan scent oughta work just as fine.",
        SPIDER_HEALER_ITEM = "I ain't treatin' the enemy.",
		...
		CRABKING_CLAW = "Catch these bullets, son!",

		MESSAGEBOTTLE = "Now who could possibly be writin' letters?",
		MESSAGEBOTTLEEMPTY = "Ain't nothin' there.",
        MEATRACK_HERMIT =
        {
			DONE = "The jerky's ready!",
			DRYING = "It's best just to let it take its time.",
		...
		MOLEBAT = "Got quite the nose on 'em.",
        MOLEBATHILL = "Not expectin' any form'a defense.",

        BATNOSE = "Sure ain't mine.",
        BATNOSE_COOKED = "A bit strange to smell.",
        BATNOSEHAT = "Really makes ya feel young again.",

        MUSHGNOME = "You know just how to bark up the wrong tree.",

        SPORE_MOON = "I'll be puttin' my sentry right between us.",

        MOON_CAP = "Can't say I'm enthused to taste its flavor.",
        MOON_CAP_COOKED = "Barbecue oughta bring out its natural flavoring.",

        MUSHTREE_MOON = "No tree like that in Texas.",

        LIGHTFLIER = "Bit of light for my travels.",

        GROTTO_POOL_BIG = "That thing might just up and tell my fortune.",
        GROTTO_POOL_SMALL = "That thing might just up and tell my fortune.",

        DUSTMOTH = "I know a few offices that could've used ya.",

        DUSTMOTHDEN = "Bug's gotta have a home.",

        ARCHIVE_LOCKBOX = "I ain't study lockpickin' much.",
        ARCHIVE_CENTIPEDE = "That's a bug that's requiring some bullets!",
        ARCHIVE_CENTIPEDE_HUSK = "Might be some good copper left in there.",
        ...
        ARCHIVE_COOKPOT =
        {
			...
			COOKING_SHORT = "It's cookin' up fast.",
			DONE = "Done and done.",
			EMPTY = "How bout we grill on this ol'slab?",
			BURNT = "Guess someone didn't know how to barbecue.",
        },

        ARCHIVE_MOON_STATUE = "That's a sight.",
        ARCHIVE_RUNE_STATUE =
        {
            LINE_1 = "I ain't familiar with the language, pardners.",
            LINE_2 = "Looks like we've got ourselves some new chicken-scratch.",
            LINE_3 = "I ain't familiar with the language, pardners.",
            LINE_4 = "Looks like we've got ourselves some new chicken-scratch.",
            LINE_5 = "I ain't familiar with the language, pardners.",
        },

        ARCHIVE_RESONATOR = {
            GENERIC = "Looks like it's got a satellite scan of this area's topography. We best get on the stick!",
            IDLE = "Looks like our job's finished here.",
        },

        ARCHIVE_RESONATOR_ITEM = "Nothin' better than reapin' your scientific rewards.",

        ARCHIVE_LOCKBOX_DISPENCER = {
          POWEROFF = "Now this'll be a passion project of mine, makin' this up to snuff.",
          GENERIC =  "Huh. Well, I'll be damned!",
        },

        ARCHIVE_SECURITY_DESK = {
            POWEROFF = "It ain't up and runnin'.",
            GENERIC = "I'm gettin' a little impressed over here!",
        },

        ARCHIVE_SECURITY_PULSE = "You ain't goin' nowhere!",

        ARCHIVE_SWITCH = {
            VALID = "This is gonna need some grease-work before we get it goin'.",
            GEMS = "Emptied outta power.",
        },

        ARCHIVE_PORTAL = {
            POWEROFF = "Don't need to be an engineer to know it ain't on.",
            GENERIC = "The first try tends to fail the most.",
        },

        WALL_STONE_2 = "No wall we can't fall.",
        WALL_RUINS_2 = "Sure it was put there for a reason.",

        REFINED_DUST = "Gets in ya nose.",
        DUSTMERINGUE = "I've been handed worse to eat.",

        SHROOMCAKE = "I'm open to all kinda cakes.",

        NIGHTMAREGROWTH = "A might worrying.",

        TURFCRAFTINGSTATION = "Can't forget your roots!",

        MOON_ALTAR_LINK = "I love it when things start fittin' in place.",

        -- FARMING
        COMPOSTINGBIN =
        {
            GENERIC = "I'm used to smells like that.",
            WET = "Soggy.",
            DRY = "Dry.",
            BALANCED = "Mighty fine compost.",
            BURNT = "Now that's real foul.",
        },
        COMPOST = "Food's good for plants.",
        SOIL_AMENDER =
		{
			GENERIC = "Won't work in just a second.",
			STALE = "Let's get this barn smellin' like one!",
			SPOILED = "Now we're talkin' country-side!",
		},

		SOIL_AMENDER_FERMENTED = "Whew! That's foul!",

        WATERINGCAN =
        {
            GENERIC = "Waterin' ain't safe for my kinda work.",
            EMPTY = "This well's run dry.",
        },
        PREMIUMWATERINGCAN =
        {
            GENERIC = "Waterin' ain't safe for my kinda work.",
		...
		FARM_PLOW = "Think I know just how this works.",
		FARM_PLOW_ITEM = "Let's get this gear moved up.",
		FARM_HOE = "I ain't done farm work in...well, I ain't got a clue.",
		GOLDEN_FARM_HOE = "Now that's just excessive.",
		NUTRIENTSGOGGLESHAT = "I'm gonna need a funeral for my fashion sense.",
		PLANTREGISTRYHAT = "Rustic. My kinda style.",

        FARM_SOIL_DEBRIS = "Got a mess to clean up.",

		FIRENETTLES = "Whoo! I can feel its fire already!",
		FORGETMELOTS = "Can't quite recall the name of these.",
		SWEETTEA = "Just perfect after an honest day's workin'.",
		TILLWEED = "Slither on back to hell, coward!",
		TILLWEEDSALVE = "Feels mighty good.",
        WEED_IVY = "This skunk's startin' to smell.",
        IVY_SNARE = "Ain't you a right kick in the plants!",

		TROPHYSCALE_OVERSIZEDVEGGIES =
		{
			GENERIC = "Just like my home's county fairs!",
			HAS_ITEM = "Weight: {weight}\nHarvested on day: {day}\nNot bad, not bad at all.",
			HAS_ITEM_HEAVY = "Weight: {weight}\nHarvested on day: {day}\nI'm takin' first place home tonight!",
            HAS_ITEM_LIGHT = "Nahhh. Too light.",
			BURNING = "I don't think that's cookin' right.",
			BURNT = "I'm missing my grill back home...",
        },

        CARROT_OVERSIZED = "Let's get this bunch weighed!",
        CORN_OVERSIZED = "Now that's one for the county fair!",
        PUMPKIN_OVERSIZED = "The whole team's eatin' tonight!",
        EGGPLANT_OVERSIZED = "Polish it up and we got a winner.",
        DURIAN_OVERSIZED = "Whew! That's a stench of victory!",
        POMEGRANATE_OVERSIZED = "Didn't think I could upgrade fruits too! Heh!",
        DRAGONFRUIT_OVERSIZED = "Ya sure it ain't a real dragon? Knowin' this place?",
        WATERMELON_OVERSIZED = "Call that an oceanmelon!",
        TOMATO_OVERSIZED = "Taken up to level 3 alright!",
        POTATO_OVERSIZED = "It's...beautiful.",
        ASPARAGUS_OVERSIZED = "That there's a Texas-sized vegetable!",
        ONION_OVERSIZED = "My industrial goggles are doin' the heavy lifting here.",
        GARLIC_OVERSIZED = "Now where's our giant batch of bread?",
        PEPPER_OVERSIZED = "Nearly the size of Texas! Nearly.",

        VEGGIE_OVERSIZED_ROTTEN = "Looks rotten to the core.",

		FARM_PLANT =
		{
			GENERIC = "That there's a plant.",
			SEED = "I'll wait.",
			GROWING = "I'm seein' a bit of growin'!",
			FULL = "Let's get this reward!",
			ROTTEN = "My thumb ain't the greenest.",
			FULL_OVERSIZED = "My god...it's beautiful!",
			ROTTEN_OVERSIZED = "Looks rotten to the core.",
			FULL_WEED = "Don't go meddlin' in my business!",

			BURNING = "Damn.",
		},

        FRUITFLY = "Go on, git! Stinkin' varmint...",
        LORDFRUITFLY = "Down with the king.",
        FRIENDLYFRUITFLY = "Guess they all ain't so bad!",
        FRUITFLYFRUIT = "Looks like I'm the new captain of a herd'a angry jellybeans.",

        SEEDPOUCH = "Lil' ammo case, for seeds 'course.",

		-- Crow Carnival
		CARNIVAL_HOST = "Howdy. Got any goods 'round here?",
		CARNIVAL_CROWKID = "Howdy.",
		CARNIVAL_GAMETOKEN = "That's nice.",
		CARNIVAL_PRIZETICKET =
		{
			GENERIC = "Grab that money!",
			GENERIC_SMALLSTACK = "Giddy-up boys, grab that money!",
			GENERIC_LARGESTACK = "Whoo, look at all that money.",
		},

		CARNIVALGAME_FEEDCHICKS_NEST = "Ya got secrets?",
		CARNIVALGAME_FEEDCHICKS_STATION =
		{
			GENERIC = "Always a catch. Tsk.",
			PLAYING = "Now I gotta feed what now?",
		},
		CARNIVALGAME_FEEDCHICKS_KIT = "I won't go peepin' at their wires now.",
		CARNIVALGAME_FEEDCHICKS_FOOD = "You best not be hopin' I'll use my mouth for this, son.",

		CARNIVALGAME_MEMORY_KIT = "Boxed up.",
		CARNIVALGAME_MEMORY_STATION =
		{
			GENERIC = "Always a catch. Tsk.",
			PLAYING = "My mind's a steel-trap. Nice try, though.",
		},
		CARNIVALGAME_MEMORY_CARD =
		{
			GENERIC = "Don't think they're needin' a backstage technician.",
			PLAYING = "I got this up to stretch.",
		},

		CARNIVALGAME_HERDING_KIT = "All boxed up.",
		CARNIVALGAME_HERDING_STATION =
		{
			GENERIC = "Always a catch. Tsk.",
			PLAYING = "You know what happens to things that run where I'm from?",
		},
		CARNIVALGAME_HERDING_CHICK = "Get over here!",

		CARNIVALGAME_SHOOTING_KIT = "All boxed up.",
		CARNIVALGAME_SHOOTING_STATION =
		{
			GENERIC = "Always a catch. Tsk.",
			PLAYING = "Oughta do this with my eyes closed! Yeehaw!",
		},
		CARNIVALGAME_SHOOTING_TARGET =
		{
			GENERIC = "Don't think they're needin' a backstage technician.",
			PLAYING = "Squash them varmints!",
		},

		CARNIVALGAME_SHOOTING_BUTTON =
		{
			GENERIC = "Always a catch. Tsk.",
			PLAYING = "Now is this here for constructin' or deconstructin'?",
		},

		CARNIVALGAME_WHEELSPIN_KIT = "All boxed up.",
		CARNIVALGAME_WHEELSPIN_STATION =
		{
			GENERIC = "Always a catch. Tsk.",
			PLAYING = "All gears gotta turn eventually.",
		},

		CARNIVALGAME_PUCKDROP_KIT = "All boxed up.",
		CARNIVALGAME_PUCKDROP_STATION =
		{
			GENERIC = "Always a catch. Tsk.",
			PLAYING = "Got a suspicion this thing ain't playin' right!",
		},

		CARNIVAL_PRIZEBOOTH_KIT = "It's a booth to boot.",
		CARNIVAL_PRIZEBOOTH =
		{
			GENERIC = "Best hope I got the tickets for 'em.",
		},

		CARNIVALCANNON_KIT = "Not sure this comes with gunpowder.",
		CARNIVALCANNON =
		{
			GENERIC = "Cute.",
			COOLDOWN = "Ain't much when you've built the real thing.",
		},

		CARNIVAL_PLAZA_KIT = "Let's see where buildin' this takes us.",
		CARNIVAL_PLAZA =
		{
			GENERIC = "I could think up a few new features, myself.",
			LEVEL_2 = "How 'bout a few more guns?",
			LEVEL_3 = "That's a wrap on that.",
		},

		CARNIVALDECOR_EGGRIDE_KIT = "Now, what'd we do with that key?",
		CARNIVALDECOR_EGGRIDE = "Heh. Like a cute lil' science fair project.",

		CARNIVALDECOR_LAMP_KIT = "A little unusual, that.",
		CARNIVALDECOR_LAMP = "A little light, that.",
		CARNIVALDECOR_PLANT_KIT = "Gettin' a few flashbacks here.",
		CARNIVALDECOR_PLANT = "Can ya at least wear it?",
		CARNIVALDECOR_BANNER_KIT = "C'mon now, this is child's engineering!",
		CARNIVALDECOR_BANNER = "Well, it sure ain't no shiny new weapon.",
		...
		CARNIVALDECOR_FIGURE_KIT = "No key required. Whew.",
		CARNIVALDECOR_FIGURE_KIT_SEASON2 = "No key required. Whew.",

        CARNIVAL_BALL = "That there's a ball. Mmhm.",--unimplemented
		CARNIVAL_SEEDPACKET = "We got seeds a plenty.",
		CARNIVALFOOD_CORNTEA = "I'll try just about anything with corn in it.",

        CARNIVAL_VEST_A = "A might rudimentary.",
        CARNIVAL_VEST_B = "Keeps ya a little cool. Barely on a temperature scale.",
        CARNIVAL_VEST_C = "A might dashing.",

        -- YOTB
        YOTB_SEWINGMACHINE = "Sewing's a little bit like engineering. Just a bit.",
        YOTB_SEWINGMACHINE_ITEM = "Gotta move this gear up.",
        YOTB_STAGE = "That there's a strange fellow.",
        YOTB_POST =  "Get to hitchin' now.",
        YOTB_STAGE_ITEM = "Gotta move this gear up.",
        YOTB_POST_ITEM =  "Gotta move this gear up.",

        YOTB_PATTERN_FRAGMENT_1 = "Best get to stitchin'.",
        YOTB_PATTERN_FRAGMENT_2 = "Best get to stitchin'.",
        YOTB_PATTERN_FRAGMENT_3 = "Best get to stitchin'.",

        YOTB_BEEFALO_DOLL_WAR = {
            GENERIC = "Just about the best teddy bear I could engineer.",
            YOTB = "Think my guns oughta convince the Judge a little. Heh!",
        },
        ...
        WAR_BLUEPRINT = "I love me some blueprints.",
        DOLL_BLUEPRINT = "I love me some blueprints.",
        FESTIVE_BLUEPRINT = "I love me some blueprints.",
        ROBOT_BLUEPRINT = "I love me some metal blueprints.",
        NATURE_BLUEPRINT = "I love me some blueprints.",
        FORMAL_BLUEPRINT = "I love me some blueprints.",
        VICTORIAN_BLUEPRINT = "I love me some blueprints.",
        ICE_BLUEPRINT = "I love me some blueprints.",
        BEAST_BLUEPRINT = "I love me some blueprints.",

        BEEF_BELL = "Time to tame some fine cattle.",

		-- YOT Catcoon
		KITCOONDEN = 
		{
			GENERIC = "Got the kittens livin' lavish.",
            BURNT = "Not my place to mourn.",
			PLAYING_HIDEANDSEEK = "Best get fetchin'.",
			PLAYING_HIDEANDSEEK_TIME_ALMOST_UP = "Now where in Sam Hill did they get to?",
		},

		KITCOONDEN_KIT = "I ain't mind a little pass-time buildin'.",

		TICOON = 
		{
			GENERIC = "Must be a thinker.",
			ABANDONED = "Up to me now.",
			SUCCESS = "Would ya lookit that!",
			LOST_TRACK = "Darn. We got beat to it.",
			NEARBY = "Must be somethin' close.",
			TRACKING = "Best to follow close by.",
			TRACKING_NOT_MINE = "Just crossin' paths is all.",
			NOTHING_TO_TRACK = "Not much left.",
			TARGET_TOO_FAR_AWAY = "They don't seem to be from 'round here.",
		},
		
		YOT_CATCOONSHRINE =
        {
            GENERIC = "Looks like it's lookin' for somethin'.",
            EMPTY = "It'd be best put with a feather.",
            BURNT = "Darn.",
        },

		KITCOON_FOREST = "Can't say I mind your meowin'.",
		KITCOON_SAVANNA = "Can't say I mind your meowin'.",
		KITCOON_MARSH = "Ain't you just the cutest?",
		KITCOON_DECIDUOUS = "Can't say I mind your meowin'.",
		KITCOON_GRASS = "Can't say I mind your meowin'.",
		KITCOON_ROCKY = "Ain't you just the cutest?",
		KITCOON_DESERT = "Ain't you just the cutest?",
		KITCOON_MOON = "Ain't you just the cutest?",
		KITCOON_YOT = "Ain't you just the cutest?",

        -- Moon Storm
        ALTERGUARDIAN_PHASE1 = {
            GENERIC = "Aw, hell! Now lookit what you've done!",
            DEAD = "We got 'em now!",
        },
        ALTERGUARDIAN_PHASE2 = {
            GENERIC = "Now we've just gone and made it mad.",
            DEAD = "Do yourself a favor, boss, stay down.",
        },
        ALTERGUARDIAN_PHASE2SPIKE = "Heh. Gonna need bullets to tear into me!",
        ALTERGUARDIAN_PHASE3 = "No more playin' 'round. Let's take this thing down!",
        ALTERGUARDIAN_PHASE3TRAP = "Whew! No time for naps on the battlefield, son!",
        ALTERGUARDIAN_PHASE3DEADORB = "Messed with the wrong team here, stretch.",
        ALTERGUARDIAN_PHASE3DEAD = "Now that's a battle worth a raise!",

        ALTERGUARDIANHAT = "My mind's glowin' sharp!",
        ALTERGUARDIANHATSHARD = "Bet that's worth a thing or two.",

        MOONSTORM_GLASS = {
            GENERIC = "Things are gettin' glassy 'round here.",
            INFUSED = "Think Mann Co. would send soldiers to die for this materiel?"
        },

        MOONSTORM_STATIC = "I'm thinkin' this has a lot less to do with science.",
        MOONSTORM_STATIC_ITEM = "Bet it makes ya hair frizzy.",
        MOONSTORM_SPARK = "Heh. Makes ya teeth chatter.",

        BIRD_MUTANT = "Just ain't right.",
        BIRD_MUTANT_SPITTER = "Just ain't right.",

        WAGSTAFF_NPC = "Now what in Sam Hill are you cookin' up out here?",

        WAGSTAFF_NPC_MUTATIONS = "You here to admire all our hard work?",
        WAGSTAFF_NPC_WAGPUNK = "Might have an inklin' of what's going on 'round here.",

        ALTERGUARDIAN_CONTAINED = "Gonna request to see the blueprints for this'un.",

        WAGSTAFF_TOOL_1 = "Ain't my tools, must be someone's.",
        WAGSTAFF_TOOL_2 = "Best get to grabbin' it.",
        WAGSTAFF_TOOL_3 = "A bit rudimentary for my likin'.",
        WAGSTAFF_TOOL_4 = "Looks like a tool alright.",
        WAGSTAFF_TOOL_5 = "Damn! Which one is this again?",

        MOONSTORM_GOGGLESHAT = "You do what ya can 'round these parts.",

        MOON_DEVICE = {
            GENERIC = "Now get a load of that! Genius!",
            CONSTRUCTION1 = "Gotta get my best googles ready for this one.",
            CONSTRUCTION2 = "Whatever it is, it's workin' alright.",
        },

		-- Wanda
        POCKETWATCH_HEAL = {
			GENERIC = "Marvel of engineerin' you've rung up!",
			RECHARGING = "It ain't as instantaneous as I was hopin'.",
		},
        ...
        POCKETWATCH_WEAPON = {
			GENERIC = "Guess if ya can't beat the clock, beat with it. Heh.",
		},

        POCKETWATCH_PARTS = "These are a might rudimentary.",
        POCKETWATCH_DISMANTLER = "Every engineer's got their favorite tools.",

        POCKETWATCH_PORTAL_ENTRANCE = 
		{
			GENERIC = "It ain't gonna wait on diddle-daddlin'!",
			DIFFERENTSHARD = "It ain't gonna wait on diddle-daddlin'!",
		},
        POCKETWATCH_PORTAL_EXIT = "That there's why ya centralize it into one handy controlled platform.",

        -- Waterlog
        WATERTREE_PILLAR = "Wooo-we! Would ya lookit that!",
        OCEANTREE = "'Bout time we found some trees out here.",
        OCEANTREENUT = "It's cookin' something up in there.",
        WATERTREE_ROOT = "Wouldn't mind takin' a peek below.",

        OCEANTREE_PILLAR = "That's good campin'.",
        
        OCEANVINE = "Oughta my way, oughta my way.",
        FIG = "That there's a good fruit.",
		FIG_COOKED = "Good fruit got better.",

        SPIDER_WATER = "I best get to makin' those water-proof sentries right about now.",
        MUTATOR_WATER = "Ain't that cute.",
        OCEANVINE_COCOON = "Not a base I'm interested spawnin' in.",
		OCEANVINE_COCOON_BURNT = "Whew! That's a smell!",

        GRASSGATOR = "C'mere fella, I ain't scary. I got the guns to prove it!",

        TREEGROWTHSOLUTION = "Sappin's good for trees, not sentries.",

        FIGATONI = "Gonna need some barbecue sauce all over this'un.",
        FIGKABAB = "Usually ya put beef on these.",
        KOALEFIG_TRUNK = "Can't say I ever saw these in any barbecue.",
        FROGNEWTON = "This here meal's flavor spans world-wide!",

        -- The Terrorarium
        TERRARIUM = {
            GENERIC = "It's got me scratchin' my head.",
            CRIMSON = "Interested in seein' where this leads us.",
            ENABLED = "That there's why ya wear goggles!",
			WAITING_FOR_DARK = "Guess it's a good time to hit the hay.",
			COOLDOWN = "Well. Guess that'll do.",
			SPAWN_DISABLED = "All done by now.",
        },

        -- Wolfgang
        MIGHTY_GYM = 
        {
            GENERIC = "A bit of hard work out in the field and you'll never look back.",
            BURNT = "That's what'cha get.",
        },

        DUMBBELL = "I ain't lookin' to strain any thinkin' muscles.",
        DUMBBELL_GOLDEN = "Get ya hands dirty with some real work and it'll do ya one better.",
		DUMBBELL_MARBLE = "Get ya hands dirty with some real work and it'll do ya one better.",
        DUMBBELL_GEM = "Get ya hands dirty with some real work and it'll do ya one better.",
        POTATOSACK = "Those ought to be gettin' eaten!",

        DUMBBELL_HEAT = "Gets ya all heated up.",
        DUMBBELL_REDGEM = "Runnin' hot!",
        DUMBBELL_BLUEGEM = "Gone all cold.",

        TERRARIUMCHEST = 
		{
			GENERIC = "I'm quite fond of openin' boxes.",
			BURNT = "Guess that's that.",
			SHIMMER = "Might be worth a key or two.",
		},

		EYEMASKHAT = "Heh. Worn worse.",

        EYEOFTERROR = "This ain't my first rodeo with your eyeball-kind!",
        EYEOFTERROR_MINI = "I ain't ever seen so many eyes at once.",
        EYEOFTERROR_MINI_GROUNDED = "You ain't doin' what I think you're doin', are ya?",

        FROZENBANANADAIQUIRI = "Good for a mellow-fellow.",
        BUNNYSTEW = "This'll keep ya goin'.",
        MILKYWHITES = "The kinda gunk you see strewn 'bout the battlefield.",

        CRITTER_EYEOFTERROR = "The more watchful eyes watchin' my machines the better.",

        SHIELDOFTERROR ="Bites ya good.",
        TWINOFTERROR1 = "Don't suppose they shoot rockets from the pupils, do ya?",
        TWINOFTERROR2 = "Don't suppose they shoot rockets from the pupils, do ya?",

		-- Cult of the Lamb
		COTL_TRINKET = "Bit on the smaller side. No shame in that.",
		TURF_COTL_GOLD = "Got my boots glowin' golden!",
		TURF_COTL_BRICK = "Fine work!",
		COTL_TABERNACLE_LEVEL1 =
		{
			LIT = "It's got light. Couldn't ask for more.",
			GENERIC = "Looks low on fuel, that.",
		},
		COTL_TABERNACLE_LEVEL2 =
		{
			LIT = "I'm startin' to see the appeal of this feller.",
			GENERIC = "Looks low on fuel, that.",
		},
		COTL_TABERNACLE_LEVEL3 =
		{
			LIT = "Guess I could stick 'round some more.",
			GENERIC = "Looks low on fuel, that.",
		},

        -- Year of the Catcoon
        CATTOY_MOUSE = "No time for playin' cat and mouse.",
        KITCOON_NAMETAG = "Not the kinda thing I'm used to taggin'.",

		KITCOONDECOR1 =
        {
            GENERIC = "Ain't got time for distractions.",
            BURNT = "Toasted, roasted.",
        },
		KITCOONDECOR2 =
        {
            GENERIC = "Ain't got time for distractions.",
		...
		KITCOONDECOR1_KIT = "Best built first.",
		KITCOONDECOR2_KIT = "Could build this up real nice.",
		-- WX78
        WX78MODULE_MAXHEALTH = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_MAXSANITY1 = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_MAXSANITY = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_MOVESPEED = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_MOVESPEED2 = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_HEAT = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_NIGHTVISION = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_COLD = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_TASER = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_LIGHT = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
		WX78MODULE_MAXHUNGER1 = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_MAXHUNGER = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_MUSIC = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_BEE = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",
        WX78MODULE_MAXHEALTH2 = "Ain't that a cute lil' module. Think they're finally catchin' up to my machines.",

        WX78_SCANNER = 
        {
            GENERIC ="Got a soft spot for little machines, myself.",
            HUNTING = "What's got your lights, pardner?",
            SCANNING = "Now what'd the bot drag in?",
        },

        WX78_SCANNER_ITEM = "Got a soft spot for little machines, myself.",
        WX78_SCANNER_SUCCEEDED = "Looks like it's done its job.",
        WX78_MODULEREMOVER = "Ain't too different from usin' a wrench.",

        SCANDATA = "Heh. I'm startin' to get a little impressed!",

		-- QOL 2022
		JUSTEGGS = "Y'all wouldn't happen to got any toast on ya?",
		VEGGIEOMLET = "Nothin' like a good breakfast to keep ya mind from foggin'.",
		TALLEGGS = "Whoowee! Got my eggs as tall as Texas!",
		BEEFALOFEED = "That there's gruel.",
		BEEFALOTREAT = "Bull's gotta eat. 'Lest you're wantin' the horns.",

        -- Pirates
        BOAT_ROTATOR = "I ought to steer us all in the proper direction.",
        BOAT_ROTATOR_KIT = "I'll have it up in no time.",
        BOAT_BUMPER_KELP = "Gotta restrain myself from upgrading it to my heart's content!",
        BOAT_BUMPER_KELP_KIT = "We got boat attachments!",
        BOAT_BUMPER_SHELL = "No stainless steel, but this ought to fit right in.",
        BOAT_BUMPER_SHELL_KIT = "We got boat attachments!",
        BOAT_CANNON = {
            GENERIC = "I ain't too used to manual loading these days.",
            AMMOLOADED = "Let's see if it's got what it takes!",
            NOAMMO = "Ammo's all out!",
        },
        BOAT_CANNON_KIT = "Let's get wranglin'!",
        CANNONBALL_ROCK_ITEM = "It's no rocket, but it'll work.",

        OCEAN_TRAWLER = {
            GENERIC = "Bit of automation helps us all.",
            LOWERED = "Oughta sit back and let the machine work its magic.",
            CAUGHT = "That was easy.",
            ESCAPED = "Now who let that one go?",
            FIXED = "Nice and repaired.",
        },
        OCEAN_TRAWLER_KIT = "Let's get on the stick with this one.",

        BOAT_MAGNET =
        {
            GENERIC = "This won't be causing any cosmic interference, now will it?",
            ACTIVATED = "Well, I'll be! When it works it works!",
        },
        BOAT_MAGNET_KIT = "Let's give your schematics a run through.",

        BOAT_MAGNET_BEACON =
        {
            GENERIC = "You best pray this one don't meddle with my machines.",
            ACTIVATED = "A might more efficient than a bullet-magnet.",
        },
        DOCK_KIT = "Let's get this dock afloat!",
        DOCK_WOODPOSTS_ITEM = "When it's done, post it.",

        MONKEYHUT =
        {
            GENERIC = "Not sure they play by textbook engineering rules.",
            BURNT = "Just ain't right.",
        },
        POWDER_MONKEY = "I ain't playin' games with you, boy!",
        PRIME_MATE = "Now calm down there, Mr. Wavy Blade.",
		LIGHTCRAB = "You light up just right.",
        CUTLESS = "Good to know we've got some tools from a prehistoric era.",
        CURSED_MONKEY_TOKEN = "Now what do we have here?",
        OAR_MONKEY = "The more oar, the better paddle.",
        BANANABUSH = "Well, I'll be! We've got bananas, boys!",
        DUG_BANANABUSH = "Well, I'll be! We've got bananas, boys!",
        PALMCONETREE = "Closest I've seen trees come to developing some armor!",
        PALMCONE_SEED = "It ain't growin' nowhere fast.",
        PALMCONE_SAPLING = "Oughta grow up any day now.",
        PALMCONE_SCALE = "Bit of tree clippin's, that.",
        MONKEYTAIL = "I'm sure there's a monkey 'round here to pin it to.",
        DUG_MONKEYTAIL = "I'm sure there's a monkey 'round here to pin it to.",

        MONKEY_MEDIUMHAT = "It's only as hard as ya presence on the ship.",
        MONKEY_SMALLHAT = "Seems like a perfect fit, don't it?",
        POLLY_ROGERSHAT = "Sure the feather's got its uses.",
        POLLY_ROGERS = "You got anything wise to say, lil' feller?",

        MONKEYISLAND_PORTAL = "I ain't one for repairin' time and space. Just ain't my area of expertise!",
        MONKEYISLAND_PORTAL_DEBRIS = "Someone's meddlin' in our business, and they sure ain't one for cleanin'.",
        MONKEYQUEEN = "Figures the apes would still be goin' through their monarchist phase.",
        MONKEYPILLAR = "They got pillars down, ain't too sure 'bout the use.",
        PIRATE_FLAG_POLE = "They sure ain't on our side.",

        BLACKFLAG = "The best ships sprout from the best engineers.",
        PIRATE_STASH = "Get diggin'!",
        STASH_MAP = "Looks like we know where the gold mine's at!",

        BANANAJUICE = "A lil' rum wouldn't sour it none.",
		FENCE_ROTATOR = "I ain't on the fence about this one. Heh.",

        CHARLIE_STAGE_POST = "We ready for a Texas rodeo out here?",
        CHARLIE_LECTURN = "I'll be watchin' from the nose bleeds.",

        CHARLIE_HECKLER = "Why don't y'all get along before one of you gets hurt.",

        PLAYBILL_THE_DOLL = "I ain't one for actin'.",
        STATUEHARP_HEDGESPAWNER = "Well, few grow back what they don't got.",
        HEDGEHOUND = "That bush's fixin' to get mean!",
        HEDGEHOUND_BUSH = "Y'all wouldn't happen to hear a mighty growlin' from this bush, now would'ya?",

        MASK_DOLLHAT = "That there's a doll.",
        MASK_DOLLBROKENHAT = "That there's a doll in disrepair.",
        MASK_DOLLREPAIREDHAT = "Looks like ya fixed it alright.",
        MASK_BLACKSMITHHAT = "That there's a blacksmith.",
        MASK_MIRRORHAT = "Ain't much for reflectin'.",
        MASK_QUEENHAT = "That there's a queen.",
        MASK_KINGHAT = "That there's a king.",
        MASK_TREEHAT = "That there's a tree.",
        MASK_FOOLHAT = "That there's a fool.",

        COSTUME_DOLL_BODY = "Costume for doll folk.",
        COSTUME_QUEEN_BODY = "Costume for Queen folk.",
        COSTUME_KING_BODY = "Costume for King folk.",
        COSTUME_BLACKSMITH_BODY = "Costume for blacksmith folk.",
        COSTUME_MIRROR_BODY = "Costume o'sorts.",
        COSTUME_TREE_BODY = "Costume for tree folk.",
        COSTUME_FOOL_BODY = "Costume for fools.",

        STAGEUSHER =
        {
            STANDING = "Now that's givin' me a spook.",
            SITTING = "That just ain't sittin' right with me.",
        },
        SEWING_MANNEQUIN =
        {
            GENERIC = "Get your loadout all sorted out.",
            BURNT = "Shoot. Hats don't look too pretty on 'em now.",
        },

		-- Waxwell
		MAGICIAN_CHEST = "Don't go stickin' your nose in where it don't belong.",
		TOPHAT_MAGICIAN = "I ain't a stranger to hats a bit unusual.",


        -- Year of the Rabbit
        YOTR_FIGHTRING_KIT = "I'm readin' these schematics and I'm likin' what I'm seein'!",
        YOTR_FIGHTRING_BELL =
        {
            GENERIC = "Y'all ready? 'Cause I'm ready!",
            PLAYING = "Cowboy up!",
        },

        YOTR_DECOR_1 = {
            GENERAL = "Fella's had a bright idea!",
            OUT = "Light's out.",
        },
        YOTR_DECOR_2 = {
            GENERAL = "Fella's had a bright idea!",
        ...
        HAREBALL = "Eugh.",
        YOTR_DECOR_1_ITEM = "Oughta pick out a spot for it.",
        YOTR_DECOR_2_ITEM = "Oughta pick out a spot for it.",

		--
		DREADSTONE = "Imagine the electron configuration on this beauty.",
		HORRORFUEL = "I know better than to meddle in that business.",
		DAYWALKER =
		{
			GENERIC = "Messed with the bull, got the horns!",
			IMPRISONED = "That there is just a sad display, boy.",
		},
		DAYWALKER_PILLAR =
		{
			GENERIC = "Y'all see what I'm seein' in there?",
			EXPOSED = "Whew! What I'd do to build with some'a that!",
		},
		ARMORDREADSTONE = "Y'think this is compliant with any... standards?",
		DREADSTONEHAT = "Science finally conjured up a hat harder than mine!",

        -- Rifts 1
        LUNARRIFT_PORTAL = "Might need a bit more than a few wrench taps over here.",
        LUNARRIFT_CRYSTAL = "A sight prettier than any crystal back home, if I were t'guess!",

        LUNARTHRALL_PLANT = "Plant yerself off our point, mister!",
        LUNARTHRALL_PLANT_VINE_END = "You need a wranglin', pardner?",

		LUNAR_GRAZER = "Don't go wasting my good bullets on this thing.",

        PUREBRILLIANCE = "Whew! Think that'll give Australium a run for its money?",
        LUNARPLANT_HUSK = "It's built up of tough stuff.",

		LUNAR_FORGE = "I'm startin' to see the light of these new ideas!",
		LUNAR_FORGE_KIT = "Let's get this built!",

		LUNARPLANT_KIT = "Fixins.",
		ARMOR_LUNARPLANT = "Leaves ain't do me any good without camouflage.",
		LUNARPLANTHAT = "Now I've seen the light!",
		BOMB_LUNARPLANT = "That there's all natural engineerin'.",
		STAFF_LUNARPLANT = "Think I'm mighty enough to wield it? Heh.",
		SWORD_LUNARPLANT = "Jury's still out. I seen what swords do to yer mind.",
		PICKAXE_LUNARPLANT = "Let's get crackin'!",
		SHOVEL_LUNARPLANT = "Show that dirt what's for.",

		BROKEN_FORGEDITEM = "My wrench's got work to do.",

        PUNCHINGBAG = "How'd that feel, dummy?",

        -- Rifts 2
        SHADOWRIFT_PORTAL = "...Anybody got a quarter?",

		SHADOW_FORGE = "Brings a whole new meaning to workin' in the dark.",
		SHADOW_FORGE_KIT = "Best get this put up!",

        FUSED_SHADELING = "You're chompin' at the wrong bits, mister.",
        FUSED_SHADELING_BOMB = "Above you!",

		VOIDCLOTH = "Bits from the battlefield.",
		VOIDCLOTH_KIT = "Fixins.",
		VOIDCLOTHHAT = "Never thought I'd see in the dark! Or is it seein' the dark?",
		ARMOR_VOIDCLOTH = "All my work clothes end up this way anyhow.",

        VOIDCLOTH_UMBRELLA = "Guess that'll do.",
        VOIDCLOTH_SCYTHE = "Always fancied myself as a bit of a farmhand!",

		SHADOWTHRALL_HANDS = "You don't wanna meddle in my business, mister.",
		SHADOWTHRALL_HORNS = "You got a hankerin' for bullets, don't ya?",
		SHADOWTHRALL_WINGS = "My Sentry's got state-of-the-art trackin' devices, son.",

        CHARLIE_NPC = "Howdy, ma'am.",
        CHARLIE_HAND = "You need a hand?",

        NITRE_FORMATION = "Good news, boys! They got rocks down here!",
        DREADSTONE_STACK = "Feels a bit wrong to stare where the sun don't shine.",
        
        SCRAPBOOK_PAGE = "Anybody lookin' for their schematics?",

        LEIF_IDOL = "I fancy a bit of wood workin' myself.",
        WOODCARVEDHAT = "Back before they invented parts that don't splinter ya skull.",
        WALKING_STICK = "As good as any stick gets, I reckon.",

        IPECACSYRUP = "How 'bout you clean this up?",
        BOMB_LUNARPLANT_WORMWOOD = "Can't say no to firepower, now can we?", -- Unused
        ...
        SUPPORT_PILLAR_SCAFFOLD = "It'll be done when it's done.",
        SUPPORT_PILLAR = "I best get to fixin' that.",
        SUPPORT_PILLAR_COMPLETE = "Ain't she a beaut!",
        SUPPORT_PILLAR_BROKEN = "Aw, shucks. Well, back to work.",

		SUPPORT_PILLAR_DREADSTONE_SCAFFOLD = "It'll be done when it's done.",
		SUPPORT_PILLAR_DREADSTONE = "I could muster up some improvements, don't 'cha think?",
		SUPPORT_PILLAR_DREADSTONE_COMPLETE = "Ain't seen better defenses than that, that weren't built by me!",
		SUPPORT_PILLAR_DREADSTONE_BROKEN = "We oughta clean that up.",

        WOLFGANG_WHISTLE = "You sure got some pipes on ya.",

        -- Rifts 3

        MUTATEDDEERCLOPS = "That just ain't right!",
        MUTATEDWARG = "Whew! That corpse breath is mighty foul!",
        MUTATEDBEARGER = "Let's send this buzzard bait back to its hole, boys!",

        LUNARFROG = "It ain't polite to stare.",

        DEERCLOPSCORPSE =
        {
            GENERIC  = "Ain't worth the jerky.",
            BURNING  = "We weren't usin' it none.",
            REVIVING = "What in Sam Hill cast that!?",
        },

        WARGCORPSE =
        {
            GENERIC  = "Guess nature'll take over from here.",
            BURNING  = "Might wanna go an' plug ya nose.",
            REVIVING = "Get your guns, boys! It's that time of year!",
        },

        BEARGERCORPSE =
        {
            GENERIC  = "Anybody wanna clean this up?",
            BURNING  = "Waste of good meat, that.",
            REVIVING = "Well I'll be, it's the witchin' hour come again!",
        },

        BEARGERFUR_SACK = "Nice bit of fur on that.",
        HOUNDSTOOTH_BLOWPIPE = "Wolverine mean.",
        DEERCLOPSEYEBALL_SENTRYWARD =
        {
            GENERIC = "Brr! Feel that dry Texan air!",    -- Enabled.
            NOEYEBALL = "Now where'd that damn eye go now?",  -- Disabled.
        },
        DEERCLOPSEYEBALL_SENTRYWARD_KIT = "Let's get to buildin'.",

        SECURITY_PULSE_CAGE = "No use empty.",
        SECURITY_PULSE_CAGE_FULL = "Ain't that a cute lil' anomaly?",

		CARPENTRY_STATION =
        {
            GENERIC = "Shoot, I sure as hell missed having a workbench.",
            BURNT = "Damn.",
        },

        WOOD_TABLE = -- Shared between the round and square tables.
        {
            GENERIC = "Mighty fine grain work, for what it's worth.",
            HAS_ITEM = "Couple of beers would do ya good.",
            BURNT = "Darn.",
        },

        WOOD_CHAIR =
        {
            GENERIC = "Plant your behind on that chair, mister.",
            OCCUPIED = "Looks like that point's occupied.",
            BURNT = "Ain't no seat safe 'round here.",
        },

        DECOR_CENTERPIECE = "Startin' to think my next PhD oughta be in the Arts.",
        DECOR_LAMP = "A work light oughta do me good.",
        DECOR_FLOWERVASE =
        {
			GENERIC = "Havin' a fixer-upper don't hurt none.",
			EMPTY = "Oughta fix it up somethin' pretty.",
        ...
        DECOR_PICTUREFRAME =
        {
            GENERIC = "Well, wouldya look at that.",
            UNDRAWN = "Must be one of them avant-garde somethin' or other.",
        },
        DECOR_PORTRAITFRAME = "Now where have I seen that before?",

        PHONOGRAPH = "Hm! Reckon we got any bluegrass records layin' about?",
        RECORD = "That's one head-achin' tune.",
        RECORD_CREEPYFOREST = "Ain't that a cute little tune.",
        RECORD_DANGER = "This tune's got my Sentry on edge.",
        RECORD_DAWN = "Oughta play us somethin' nice.",
        RECORD_DRSTYLE = "Ain't that a cute little tune.",
        RECORD_DUSK = "Oughta play us somethin' nice.",
        RECORD_EFS = "Lounge records. Got a quarter?",
        RECORD_END = "Ain't that a cute little tune.",
        RECORD_MAIN = "Oughta play us somethin' nice.",
        RECORD_WORKTOBEDONE = "Lounge records. Got a quarter?",

        ARCHIVE_ORCHESTRINA_MAIN = "Gotta let this one sit a lil' longer in the mind palace.",

        WAGPUNKHAT = "It ain't much, but I'm likin' these schematics.",
        ARMORWAGPUNK = "I seen better engineered chest-plates coughed up on a lunch break.",
        WAGSTAFF_MACHINERY = "Now what slice of engineerin' do we got here?",
        WAGPUNK_BITS = "Ain't no bits of scrap here compatible with my line of work.",
        WAGPUNKBITS_KIT = "Think I oughta try an' fix 'er up? Nahhh.",

        WAGSTAFF_MUTATIONS_NOTE = "Let's see what old layabouts 'round here been cooked up.",
        -- Meta 3

        BATTLESONG_INSTANT_REVIVE = "Ain't got words for how much bein' dead gets me mad.",

        WATHGRITHR_IMPROVEDHAT = "You ready for lift off?",
        SPEAR_WATHGRITHR_LIGHTNING = "Heh. Thought you were a singer, not a conductor!",

        BATTLESONG_CONTAINER = "There ain't no containing those from the stage.",

        SADDLE_WATHGRITHR = "We're ridin' higher an'higher!",

        WATHGRITHR_SHIELD = "I reckon I'll be standin' behind that.",

        BATTLESONG_SHADOWALIGNED = "I ain't the singin' type. Just strummin'.",
        BATTLESONG_LUNARALIGNED = "I ain't the singin' type. Just strummin'.",

		SHARKBOI = "Do I got your teeth chattering already, pardner?",
        BOOTLEG = "I reckon that's enough boot to kick some serious behind.",
        OCEANWHIRLPORTAL = "You lookin' for a swirly?",
	},
	...
	DESCRIBE_PLANTHAPPY = "That there's a happy plant.",
    DESCRIBE_PLANTVERYSTRESSED = "Something's stressin' it out!",
    DESCRIBE_PLANTSTRESSED = "Think it ain't in the brightest mood.",
    DESCRIBE_PLANTSTRESSORKILLJOYS = "Somebody need a wrench to the leaves 'round here?",
    DESCRIBE_PLANTSTRESSORFAMILY = "Oughta construct some robotic plants to simulate friendship.",
    DESCRIBE_PLANTSTRESSOROVERCROWDING = "This might be a bit much for it.",
    DESCRIBE_PLANTSTRESSORSEASON = "The season's gettin' the better of it.",
    DESCRIBE_PLANTSTRESSORMOISTURE = "Might'n need a drink or two.",
    DESCRIBE_PLANTSTRESSORNUTRIENTS = "Ya starvin'?",
    DESCRIBE_PLANTSTRESSORHAPPINESS = "I don't- you ain't askin' me to talk to a plant are ya?",

	EAT_FOOD =
	{
		TALLBIRDEGG_CRACKED = "Booo! That's fowl.",
