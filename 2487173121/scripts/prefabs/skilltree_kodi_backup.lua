...
local function BuildSkillsData(SkillTreeFns)
    ...
    local skills = {
        kodi_fox_speed_1 = {
            ...
            desc = KODI.FOX_SPEED_1_DESC or "Increases movement speed by 5%.",
            icon = "fast_fox",
            pos = {COL1_X, TOP_Y},
            group = "kodi_fox",
            tags = {"fox", "fox_main"},
        ...
        kodi_fox_speed_2 = {
            ...
            desc = KODI.FOX_SPEED_2_DESC or "Increases movement speed by additional 5%.",
            icon = "fast_fox2",
        ...
        kodi_fox_speed_3 = {
            ...
            desc = KODI.FOX_SPEED_3_DESC or "Increases movement speed by additional 5%. Bonus speed at night.",
            icon = "fast_fox3",
        ...
        kodi_fox_cold_3 = {
            ...
            desc = KODI.FOX_COLD_3_DESC or "Immune to freezing damage.",
            icon = "fluffy_fur3",
        ...
        kodi_fox_lock = {
            ...
            lock_open = function(prefabname, activatedskills, readonly)
                return SkillTreeFns.CountTags(prefabname, "fox_main", activatedskills) >= 3
            end,
        ...
        kodi_fox_lock_day_excl = {
            ...
            tags = {"fox", "lock"},
            lock_open = function(prefabname, activatedskills, readonly)
                if SkillTreeFns.CountTags(prefabname, "night_hunter", activatedskills) == 0 then
                    return true
                end
                return nil
            end,
        ...
        kodi_fox_lock_night_excl = {
            ...
            tags = {"fox", "lock"},
            lock_open = function(prefabname, activatedskills, readonly)
                if SkillTreeFns.CountTags(prefabname, "day_stalker", activatedskills) == 0 then
                    return true
                end
                return nil
            end,
        ...
        kodi_fox_night_hunter = {
            ...
            desc = KODI.FOX_NIGHT_HUNTER_DESC or "Mark target, see through darkness, shadow leap for DOUBLE damage. Night bonuses: +range, +damage. [Excludes Day Stalker]",
        ...
        kodi_demon_lock_hands_excl = {
            desc = KODI.DEMON_LOCK_ERUPTION_DESC or "Cannot have Shadow Eruption.\nRequires: Demonic Mastery, Dark Power II, Shadow Step II.",
            pos = {COL2_X - STEP_X, TOP_Y - 54 - STEP_Y * 2},
            group = "kodi_demon",
            tags = {"demon", "lock"},
            lock_open = function(prefabname, activatedskills, readonly)
                if SkillTreeFns.CountTags(prefabname, "shadow_eruption", activatedskills) == 0 then
                    if activatedskills
                       and activatedskills["kodi_demon_mastery"]
                       and activatedskills["kodi_demon_damage_2"]
                       and activatedskills["kodi_demon_dash_2"] then
                        return true
                    end
                    return false
                end
        ...
        kodi_demon_lock_eruption_excl = {
            ...
            tags = {"demon", "lock"},
            lock_open = function(prefabname, activatedskills, readonly)
                if SkillTreeFns.CountTags(prefabname, "shadow_hands", activatedskills) == 0 then
                    if activatedskills
                       and activatedskills["kodi_demon_mastery"]
                       and activatedskills["kodi_demon_damage_2"]
                       and activatedskills["kodi_demon_dash_2"] then
        ...
        kodi_survival_scavenger_1 = {
            title = KODI.SURVIVAL_SCAVENGER_1_TITLE or "Scavenger's Nose I",
            desc = KODI.SURVIVAL_SCAVENGER_1_DESC or "Sense nearby food through fog of war (15 tiles radius).",
            icon = "wilson_allegiance_shadow_1",
            pos = {COL3_X, TOP_Y},
            group = "kodi_survival",
        ...
        kodi_survival_scavenger_2 = {
            ...
            icon = "wilson_allegiance_shadow_2",
        ...
        kodi_survival_scavenger_3 = {
            ...
            desc = KODI.SURVIVAL_SCAVENGER_3_DESC or "Can eat spoiled food without penalties. Spoiled food restores 50% of original value.",
            icon = "wilson_allegiance_shadow_3",
        ...
        kodi_survival_cunning_1 = {
            title = KODI.SURVIVAL_CUNNING_1_TITLE or "Escape Instinct",
            desc = KODI.SURVIVAL_CUNNING_1_DESC or "+30% movement speed when below 50% health.",
            icon = "wilson_torch_lighter_1",
            ...
            onactivate = function(inst, fromload)
                ...
                inst:AddTag("kodi_escape_instinct")
            end,
            ondeactivate = function(inst, fromload)
                inst:RemoveTag("kodi_cunning_1")
                inst:RemoveTag("kodi_escape_instinct")
            end,
        },
        ...
        kodi_survival_cunning_3 = {
            title = KODI.SURVIVAL_CUNNING_3_TITLE or "Shadow Horn",
            desc = KODI.SURVIVAL_CUNNING_3_DESC or "A cursed horn is buried somewhere in the world. Find it to summon shadow creatures.",
            icon = "wilson_torch_lighter_3",
            ...
            onactivate = function(inst, fromload)
                ...
                inst:AddTag("kodi_shadow_horn")
                if not fromload and TheWorld.ismastersim then
                    inst:DoTaskInTime(0.5, function()
                        if inst.SpawnShadowHornMound then
                            inst:SpawnShadowHornMound()
                        end
                    end)
                end
            end,
            ondeactivate = function(inst, fromload)
                ...
                inst:RemoveTag("kodi_shadow_horn")
            end,
        },
        kodi_survival_lock = {
            ...
            tags = {"survival", "lock"},
            lock_open = function(prefabname, activatedskills, readonly)
                return SkillTreeFns.CountTags(prefabname, "survival_main", activatedskills) >= 3
            end,
        ...
        kodi_survival_lock_cache_excl = {
            ...
            tags = {"survival", "lock"},
            lock_open = function(prefabname, activatedskills, readonly)
                if SkillTreeFns.CountTags(prefabname, "shadow_minion", activatedskills) == 0 then
                    return true
                end
                return nil
            end,
        ...
        kodi_survival_lock_minion_excl = {
            ...
            tags = {"survival", "lock"},
            lock_open = function(prefabname, activatedskills, readonly)
                if SkillTreeFns.CountTags(prefabname, "shadow_cache", activatedskills) == 0 then
                    return true
                end
                return nil
            end,
        ...
        kodi_survival_shadow_cache = {
            ...
            desc = KODI.SURVIVAL_SHADOW_CACHE_DESC or "Open a portal to shadow dimension. Store up to 4 items that persist through death. Press [H] to open.",
            icon = "wilson_allegiance_shadow_lock",
            pos = {COL3_X - 4, 15},
            group = "kodi_survival",
        ...
        kodi_survival_shadow_minion = {
            ...
            desc = KODI.SURVIVAL_SHADOW_MINION_DESC or "Press [H] near a fresh corpse to raise a shadow copy. Fights for you and explodes on death. Lasts 3-4 minutes.",
            icon = "wilson_torch_throw",
