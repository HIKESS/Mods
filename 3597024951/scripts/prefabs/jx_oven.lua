      ...
      if data.burnt then
        ...
        elseif item2 then
          ...
          if copy_item_2 ~= nil then
            --copy_item_2.Transform:SetPosition(inst.Transform:GetWorldPosition())
...
local function OnGetItemFromPlayer(inst, giver, item)
  ...
  if inst.decor and inst.decor:IsValid() then
    ...
    if copy_item_1 ~= nil then
      --copy_item_1.Transform:SetPosition(inst.Transform:GetWorldPosition())
      ...
      if copy_item_1.components.perishable then
        copy_item_1.components.perishable:StopPerishing()
      end
      copy_item_1.persists = false
