...
function MakeWallType(data)
    ...
    local function itemfn()
      ...
      inst.components.repairer.repairmaterial = (data.name == "jx_straw_1" and "hay") or data.material
    ...
    local function fn()
      ...
      inst.components.repairable.repairmaterial = (data.name == "jx_straw_1" and "hay") or data.material
