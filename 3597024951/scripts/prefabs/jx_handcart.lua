local assets =
{
    Asset("ANIM", "anim/jx_handcart.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("jx_handcart.tex")
    
    inst:AddTag("structure")
    
    inst.AnimState:SetBank("jx_handcart")
    inst.AnimState:SetBuild("jx_handcart")
    ...
    inst.components.container:WidgetSetup("jx_handcart") 
...
return Prefab("jx_handcart", fn, assets, prefabs),
  MakePlacer("jx_handcart_placer", "jx_handcart", "jx_handcart", "idle_empty")