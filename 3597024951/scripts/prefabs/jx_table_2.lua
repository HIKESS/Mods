...
local function OnGetItemFromPlayer(inst, giver, item)
  ...
  if copy_item.components.brain then
    BrainManager:Hibernate(copy_item)
  end
  if item.lamp_canlight and not item:HasTag("canlight") then
    copy_item:PushEvent("onlighterlight")
  end
