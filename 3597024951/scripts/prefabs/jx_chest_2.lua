local assets =
{
  Asset("ANIM", "anim/jx_chest_2.zip"),
  Asset("ANIM", "anim/jx_chest_2_upgraded.zip"),
}
...
local function regular_ShouldCollapse(inst)
	if inst.components.container and inst.components.container.infinitestacksize then
		...
		for k, v in pairs(inst.components.container.slots) do
			local stackable = v and v.components.stackable
			if stackable then
...
local function DoUpgradeVisuals(inst)
    ...
    inst.AnimState:SetBank("jx_chest_2_upgraded")
    inst.AnimState:SetBuild("jx_chest_2_upgraded")
    --if skin_name ~= "" then
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("jx_chest_2.tex")
    ...
    inst.AnimState:SetBank("jx_chest_2")
    inst.AnimState:SetBuild("jx_chest_2")
    ...
    inst.components.container:WidgetSetup("jx_chest_2")
...
return Prefab("jx_chest_2", fn, assets, prefabs),
    MakePlacer("jx_chest_2_placer", "jx_chest_2", "jx_chest_2", "closed")