...
local DOOR_LOOT = { "boards", "boards", "rope" }--111
local FENCE_LOOT = { "rocks" }

SetSharedLootTable("fence_junk",--111
{
	{ "wagpunk_bits",	0.25	},
	{ "twigs",			1.0		},
})
...
local function MakeWall(name, anims, isdoor, klaussackkeyid, data)
    ...
    if isdoor then
        ...
        for _, v in ipairs(wall_prefabs) do
...
local function MakeInvItem(name, placement, animdata, isdoor)
    ...
    local function ondeploywall(inst, pt, deployer, rot )
        ...
        if wall ~= nil then
            ...
            wall.SoundEmitter:PlaySound("dontstarve/common/place_structure_stone", nil, .5)
        end
    end
...
return 
  MakeWall("jx_fence", { wide="jx_fence", narrow="jx_fence_thin" }, false),
  MakeInvItem("jx_fence_item", "jx_fence", "jx_fence", false),
  MakeWallPlacer("jx_fence_item_placer", "jx_fence", { wide="jx_fence", narrow="jx_fence_thin" }, false),
  ---
  MakeWall("jx_fence_2", { wide="jx_fence_2", narrow="jx_fence_2_thin" }, false),
  MakeInvItem("jx_fence_2_item", "jx_fence_2", "jx_fence_2", false),
  MakeWallPlacer("jx_fence_2_item_placer", "jx_fence_2", { wide="jx_fence_2", narrow="jx_fence_2_thin" }, false)