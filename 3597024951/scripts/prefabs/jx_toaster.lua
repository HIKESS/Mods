...
local function UpdateImages(inst, range)
    ...
    inst.components.inventoryitem:ChangeImageName("jx_toaster"..tostring(range))
    if range == 5 then
...
local function fn()
    ...
    inst.components.inventoryitem.atlasname = "images/inventoryimages/jx_inventoryimages1.xml"
