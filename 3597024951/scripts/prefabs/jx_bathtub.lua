...
local function ShouldAcceptItem(inst, item, giver)
  return item and item.prefab == "cutstone" and 
    inst.components.finiteuses and inst.components.finiteuses:GetPercent() < 1 or false
end
...
local function fn()
    ...
    inst.components.finiteuses:SetMaxUses(TUNING.JX_TUNING.jx_bathtub_finiteuses)
    inst.components.finiteuses:SetUses(TUNING.JX_TUNING.jx_bathtub_finiteuses)
    
    if TUNING.JX_TUNING.jx_bathtub_cutstone ~= false then
