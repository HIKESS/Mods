...
local assets2 =
{
    Asset("ANIM", "anim/jx_cookpot_2.zip"),
    Asset("ANIM", "anim/cook_pot_food.zip"),
    Asset("ANIM", "anim/ui_cookpot_1x4.zip"),
}
...
local function spoilfn(inst)
    if not inst:HasTag("burnt") then
        if TUNING.JX_TUNING.jx_cookpot_spoil == true then
          inst.components.stewer.spoiltime = 1
					inst.components.stewer.targettime = GetTime()
...
local function fn()
    ...
    inst.components.stewer.cooktimemult = TUNING.JX_TUNING.jx_cookpot_cooktimemult
...
local function fn2()
    ...
    inst.AnimState:SetBank("jx_cookpot_2")
    inst.AnimState:SetBuild("jx_cookpot_2")
    inst.AnimState:PlayAnimation("idle_empty")

    inst.MiniMapEntity:SetIcon("jx_cookpot_2.tex")
    ...
    inst.components.stewer.ondonecooking = donecookfn
    inst.components.stewer.onharvest = harvestfn
    inst.components.stewer.onspoil = spoilfn2
    inst.components.stewer.cooktimemult = TUNING.JX_TUNING.jx_cookpot_2_cooktimemult

    inst:AddComponent("container")
    inst.components.container:WidgetSetup("jx_cookpot_2")
    inst.components.container.onopenfn = onopen
    inst.components.container.onclosefn = onclose
    inst.components.container.skipclosesnd = true
    inst.components.container.skipopensnd = true
...
return Prefab("jx_cookpot", fn, assets),
  Prefab("jx_cookpot_2", fn2, assets2),
  MakePlacer("jx_cookpot_placer", "jx_cookpot", "jx_cookpot", "idle_empty"),
  MakePlacer("jx_cookpot_2_placer", "jx_cookpot_2", "jx_cookpot_2", "idle_empty")
