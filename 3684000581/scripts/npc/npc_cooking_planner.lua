...
local CookingRecipes = require("npc/npc_cooking_recipes")
...
--  注入子模块方法
-- ═══════════════════════════════════════════════════════════════════════════
require("npc/npc_cooking_ingredient_finder").AttachTo(CookingPlanner)
require("npc/npc_cooking_recipe_scorer").AttachTo(CookingPlanner)
