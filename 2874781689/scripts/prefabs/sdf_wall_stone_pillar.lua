...
local assets=
{
    Asset("ANIM", "anim/sdf_wall_stone_pillar.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("sdf_wall_stone_pillar")
    inst.AnimState:SetBuild("sdf_wall_stone_pillar")
...
return  Prefab("sdf_wall_stone_pillar", fn, assets)