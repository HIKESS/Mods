local assets=
{
    Asset("ANIM", "anim/sdf_chest_pumpkin.zip"),
...
local function makebarrenfn(inst)
	...
	--SpawnPrefab("sdf_chest_pumpkin_gorge_empty").Transform:SetPosition(x,_,z)

	local sdf_chest_pumpkin = SpawnPrefab("sdf_chest_pumpkin_empty")
	sdf_chest_pumpkin.Transform:SetPosition(x,_,z)
	if inst.lootid == 1 then
	    sdf_chest_pumpkin.lootid = 1
	    -- sdf_chest_pumpkin.components.lootdropper:SetLoot({"sdf_silver_shield"})
	end
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("sdf_chest_pumpkin_mm.tex")

    inst.AnimState:SetBank("sdf_chest_pumpkin")
    inst.AnimState:SetBuild("sdf_chest_pumpkin")
...
local function on_day_change(inst)
	...
	inst:DoTaskInTime(0.5, function()
	    local x,_,z = inst.Transform:GetWorldPosition()
	    local sdf_chest_pumpkin = SpawnPrefab("sdf_chest_pumpkin")
	    sdf_chest_pumpkin.Transform:SetPosition(x,_,z)
	    if inst.lootid == 1 then
		sdf_chest_pumpkin.lootid = 1
		sdf_chest_pumpkin.components.lootdropper:SetLoot({"sdf_silver_shield"})
...
local function fn2()
    ...
    inst.components.sdf_chest_regeneration:SetMaxRegenerationCount(TUNING.SDF_CHEST_PUMPKIN_REGENERATION_DAY_MAX)
...
return  Prefab("sdf_chest_pumpkin", fn, assets),
	Prefab("sdf_chest_pumpkin_empty", fn2, assets)