...
local function SetHarvest(inst)
    ...
    local pumpkingCreeper = SpawnPrefab("sdf_pumpking_creeper")
    if pumpkingCreeper ~= nil then
	pumpkingCreeper.Transform:SetPosition(inst.Transform:GetWorldPosition())
	pumpkingCreeper.persists = false
    end
...
local function GetGrowthStages(inst)
    return growth_stages[inst.build] or growth_stages["sdf_pumpking_creeper_plant"]
end

local function GetBuild(inst)
    return builds[inst.build] or builds["sdf_pumpking_creeper_plant"]
end
...
local function fn()
    ...
    inst.build = "sdf_pumpking_creeper_plant"
...
return Prefab("sdf_pumpking_creeper_plant", fn, assets, prefabs)
