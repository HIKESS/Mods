...
local function fn()
    ...
    inst.components.health:SetMaxHealth(TUNING.WOODWALL_HEALTH)
    inst.components.health:SetCurrentHealth(TUNING.WOODWALL_HEALTH * .5)
...
return  Prefab("sdf_wall_wood", fn, assets)