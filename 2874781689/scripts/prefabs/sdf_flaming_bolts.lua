local assets=
{
    ...
    Asset("ANIM", "anim/sdf_flaming_bolts.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("sdf_flaming_bolts")
    inst.AnimState:SetBuild("sdf_flaming_bolts")
    ...
    inst:AddTag("sdf_flaming_crossbow_ammo")
    ...
    inst.components.weapon:SetDamage(TUNING.SDF_FLAMING_BOLTS_DAMAGE)

    inst:AddComponent("projectile")
    inst.components.projectile:SetSpeed(TUNING.SDF_FLAMING_BOLTS_PROJECTILE_SPEED)
    ...
    inst.components.projectile.range = TUNING.SDF_FLAMING_CROSSBOW_RANGE + 4
    ...
    inst.components.stackable.maxsize = TUNING.SDF_FLAMING_BOLTS_MAXSTACKCOUNT

    inst:AddComponent("inventoryitem")
    inst.components.inventoryitem.imagename = "sdf_flaming_bolts"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sdf_flaming_bolts.xml"
...
return  Prefab("common/inventory/sdf_flaming_bolts", fn, assets)