local assets =
{
    ...
    Asset("ANIM", "anim/sdf_silver_shield.zip"),
    Asset("ANIM", "anim/swap_sdf_silver_shield.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("sdf_silver_shield")
    inst.AnimState:SetBuild("sdf_silver_shield")
    inst.AnimState:PlayAnimation("anim")
    ...
    inst.components.inventoryitem.imagename = "sdf_silver_shield"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sdf_silver_shield.xml"
    ...
    inst.components.armor:InitCondition(TUNING.SDF_SILVER_SHIELD_DURABILITY, 0)
...
return Prefab("sdf_silver_shield", fn, assets, prefabs)