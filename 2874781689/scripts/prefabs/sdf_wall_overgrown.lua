...
local assets=
{
    Asset("ANIM", "anim/sdf_wall_overgrown.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("sdf_wall_overgrown")
    inst.AnimState:SetBuild("sdf_wall_overgrown")
...
return  Prefab("sdf_wall_overgrown", fn, assets)