local assets =
{
    ...
    Asset("ANIM", "anim/sdf_copper_shield.zip"),
    Asset("ANIM", "anim/swap_sdf_copper_shield.zip"),
...
local function fn()
    ...
    inst.AnimState:SetBank("sdf_copper_shield")
    inst.AnimState:SetBuild("sdf_copper_shield")
    ...
    inst.components.inventoryitem.imagename = "sdf_copper_shield"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sdf_copper_shield.xml"
    ...
    inst.components.armor:InitCondition(TUNING.SDF_COPPER_SHIELD_DURABILITY, 0)
	...
	if inst.DaringDashArmor == 0 then
		...
		self.inst._myShieldDamageWas = damage_amount
		owner:DoTaskInTime(1, function()
		    owner.components.talker:Say(""..self.inst._myShieldDamageWas.."")
		end)
	    end]]
	else
	    ...
	    if owner and owner.components.combat then
		self.inst._myShieldDamageWas = damage_amount
		self.inst._myShieldDamageIs = (damage_amount* self.inst.DaringDashArmor)
		owner:DoTaskInTime(1, function()
		    owner.components.talker:Say(""..self.inst._myShieldDamageWas.." / "..self.inst._myShieldDamageIs.."")
		end)
	    end]]
	end
    ...
    --testing
    --inst._myShieldDamageWas = 0
    --inst._myShieldDamageIs = 0
...
return Prefab("sdf_copper_shield", fn, assets, prefabs)