...
local assets=
{
    Asset("ANIM", "anim/sdf_wall_hedge_decor.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("sdf_wall_hedge_decor")
    inst.AnimState:SetBuild("sdf_wall_hedge_decor")
...
return  Prefab("sdf_wall_hedge_decor", fn, assets)