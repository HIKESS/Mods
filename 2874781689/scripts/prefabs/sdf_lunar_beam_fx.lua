local assets =
{
    Asset("ANIM", "anim/sdf_lunar_beam_fx.zip"),
}
...
local function createbeam(layer, offset)
    ...
    local function fn()
        ...
        inst.AnimState:SetBank("sdf_lunar_beam_fx")
        inst.AnimState:SetBuild("sdf_lunar_beam_fx")
    ...
    return Prefab("sdf_lunar_beam_"..layer, fn, assets)
end
...
local function createpulse(offset)
    ...
    return Prefab("sdf_lunar_beam_pulse", fn, assets)
end
