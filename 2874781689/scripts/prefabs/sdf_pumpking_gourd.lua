...
local function frozenState(inst)
    ...
    inst.components.freezable.damagetobreak = TUNING.SDF_PUMPKING_GOURD_HEALTH * 0.25
...
local function WakeUp(inst)
	...
	frozenState(inst)
        ...
        --inst.hibernatetask = inst:DoTaskInTime(TUNING.SDF_PUMPKING_GOURD_FREEZE_TIME, WakeUp)
    else
	--unfreeze frozen
...
local function FreshSpawn(inst)
    ...
    inst.hibernatetask = inst:DoTaskInTime(TUNING.SDF_PUMPKING_GOURD_HIBERNATE_TIME, WakeUp)
end
...
local function fn()
    ...
    inst:AddTag("sdf_pumpking_gourd")
    ...
    inst.components.sdf_pumpking_gourd_vine_spawner:SetMinionType("sdf_pumpking_gourd_vine")
    inst.components.sdf_pumpking_gourd_vine_spawner:SetMinionSpawnTime({ min = TUNING.SDF_PUMPKING_GOURD_VINE_SPAWN_TIME, max = TUNING.SDF_PUMPKING_GOURD_VINE_REGEN_TIME })
    inst.components.sdf_pumpking_gourd_vine_spawner:SetSpawnTime(TUNING.SDF_PUMPKING_GOURD_VINE_SPAWN_TIME)
    inst.components.sdf_pumpking_gourd_vine_spawner:SetMaxMinion(TUNING.SDF_PUMPKING_GOURD_VINE_SPAWN_MAX)
    inst.components.sdf_pumpking_gourd_vine_spawner:SetMaxMinionPool(TUNING.SDF_PUMPKING_GOURD_VINE_SPAWN_MAX)
    inst.components.sdf_pumpking_gourd_vine_spawner:SetDistanceModifier(TUNING.SDF_PUMPKING_GOURD_VINE_SPAWN_DIST)
    inst.components.sdf_pumpking_gourd_vine_spawner.validtiletypes = VALID_TILE_TYPES

    inst:AddComponent("health")
    inst.components.health:SetMaxHealth(TUNING.SDF_PUMPKING_GOURD_HEALTH)
...
return Prefab("sdf_pumpking_gourd", fn, assets, prefabs)