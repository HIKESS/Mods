local assets=
{
    ...
    Asset("ANIM", "anim/sdf_standard_arrows.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("sdf_standard_arrows")
    inst.AnimState:SetBuild("sdf_standard_arrows")
    ...
    inst.components.weapon:SetDamage(TUNING.SDF_STANDARD_ARROWS_DAMAGE)

    inst:AddComponent("projectile")
    inst.components.projectile:SetSpeed(TUNING.SDF_STANDARD_ARROWS_PROJECTILE_SPEED)
    ...
    inst.components.projectile.range = TUNING.SDF_LONGBOW_RANGE + 4
    ...
    inst.components.stackable.maxsize = TUNING.SDF_STANDARD_ARROWS_MAXSTACKCOUNT

    inst:AddComponent("inventoryitem")
    inst.components.inventoryitem.imagename = "sdf_standard_arrows"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/sdf_standard_arrows.xml"
...
return  Prefab("common/inventory/sdf_standard_arrows", fn, assets)