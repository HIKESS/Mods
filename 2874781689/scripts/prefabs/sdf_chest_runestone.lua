local assets=
{
    Asset("ANIM", "anim/sdf_chest_runestone.zip"),
...
local function fn()
    ...
    inst.MiniMapEntity:SetIcon("sdf_chest_runestone_mm.tex")

    inst.AnimState:SetBank("sdf_chest_runestone")
    inst.AnimState:SetBuild("sdf_chest_runestone")
    ...
    inst.lootchest = {"goldnugget","goldnugget","goldnugget","goldnugget","sdf_energyvial"}
...
return  Prefab("sdf_chest_runestone", fn, assets)