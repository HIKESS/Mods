local assets=
{
    Asset("ANIM", "anim/sdf_professors_lab_table.zip"),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("sdf_professors_lab_table")
    inst.AnimState:SetBuild("sdf_professors_lab_table")
...
return  Prefab("sdf_professors_lab_table", fn, assets)