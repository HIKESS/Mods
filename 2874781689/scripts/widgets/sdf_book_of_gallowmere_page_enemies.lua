...
local SDFBookOfGallowmerePageEnemies = Class(Widget, function(self, owner)
	Widget._ctor(self, "SDFBookOfGallowmerePageEnemies")

	self.page_enemies = SDFTheBookOfGallowmere.page_enemies or {  }
	...
	self.page = self:AddChild(Image("images/pageimages/"..self.page_enemies[0]..".xml", ""..self.page_enemies[0]..".tex"))
...
function SDFBookOfGallowmerePageEnemies:CreateLastPageTurnerAnimation(newPageNumber)
	--Stop fast animation
	...
	self.inst:DoTaskInTime(1, function()
	    self.page:SetFadeAlpha(0, true)
	    self.page:SetTexture("images/pageimages/"..self.page_enemies[newPageNumber]..".xml", ""..self.page_enemies[newPageNumber]..".tex")
	    self.page:SetSize(HUDHeight, HUDWidth)
	end)
...
function SDFBookOfGallowmerePageEnemies:CreateLastPageTurnerEndAnimation(newPageNumber)
	--Stop fast animation
	self.turningPage = true
...
function SDFBookOfGallowmerePageEnemies:CreateNextPageTurnerAnimation(newPageNumber)
	--Stop fast animation
	self.turningPage = true
...
function SDFBookOfGallowmerePageEnemies:CreateNextPageTurnerEndAnimation(newPageNumber)
	--Stop fast animation
	self.turningPage = true
...
function SDFBookOfGallowmerePageEnemies:CreateLastPageTurner()
	...
	lastPageTurner:SetOnClick(function()
		...
		if self.page_enemies[lastPageNumber] ~= nil then
		    self:CreateLastPageTurnerAnimation(lastPageNumber)
		    self.currentPage = lastPageNumber
		end
	    else
		if self.page_enemies[self.maxPageTotal] ~= nil then
...
function SDFBookOfGallowmerePageEnemies:CreateNextPageTurner()
	...
	nextPageTurner:SetOnClick(function()
		...
		if self.page_enemies[nextPageNumber] ~= nil then
...
return SDFBookOfGallowmerePageEnemies