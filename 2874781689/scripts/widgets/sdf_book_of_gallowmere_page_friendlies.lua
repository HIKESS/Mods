...
local SDFBookOfGallowmerePageFriendlies = Class(Widget, function(self, owner)
	Widget._ctor(self, "SDFBookOfGallowmerePageFriendlies")

	self.page_friendlies = SDFTheBookOfGallowmere.page_friendlies or {  }
	...
	self.page = self:AddChild(Image("images/pageimages/"..self.page_friendlies[0]..".xml", ""..self.page_friendlies[0]..".tex"))
...
function SDFBookOfGallowmerePageFriendlies:CreateLastPageTurnerAnimation(newPageNumber)
	--Stop fast animation
	...
	self.inst:DoTaskInTime(1, function()
	    self.page:SetFadeAlpha(0, true)
	    self.page:SetTexture("images/pageimages/"..self.page_friendlies[newPageNumber]..".xml", ""..self.page_friendlies[newPageNumber]..".tex")
	    self.page:SetSize(HUDHeight, HUDWidth)
	end)
...
function SDFBookOfGallowmerePageFriendlies:CreateLastPageTurnerEndAnimation(newPageNumber)
	--Stop fast animation
	self.turningPage = true
...
function SDFBookOfGallowmerePageFriendlies:CreateNextPageTurnerAnimation(newPageNumber)
	--Stop fast animation
	self.turningPage = true
...
function SDFBookOfGallowmerePageFriendlies:CreateNextPageTurnerEndAnimation(newPageNumber)
	--Stop fast animation
	self.turningPage = true
...
function SDFBookOfGallowmerePageFriendlies:CreateLastPageTurner()
	...
	lastPageTurner:SetOnClick(function()
		...
		if self.page_friendlies[lastPageNumber] ~= nil then
		    self:CreateLastPageTurnerAnimation(lastPageNumber)
		    self.currentPage = lastPageNumber
		end
	    else
		if self.page_friendlies[self.maxPageTotal] ~= nil then
...
function SDFBookOfGallowmerePageFriendlies:CreateNextPageTurner()
	...
	nextPageTurner:SetOnClick(function()
		...
		if self.page_friendlies[nextPageNumber] ~= nil then
...
return SDFBookOfGallowmerePageFriendlies