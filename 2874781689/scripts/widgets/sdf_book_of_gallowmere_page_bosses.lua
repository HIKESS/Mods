...
local SDFBookOfGallowmerePageBosses = Class(Widget, function(self, owner)
	Widget._ctor(self, "SDFBookOfGallowmerePageBosses")

	self.page_bosses = SDFTheBookOfGallowmere.page_bosses or {  }
	...
	self.page = self:AddChild(Image("images/pageimages/"..self.page_bosses[0]..".xml", ""..self.page_bosses[0]..".tex"))
...
function SDFBookOfGallowmerePageBosses:CreateLastPageTurnerAnimation(newPageNumber)
	--Stop fast animation
	...
	self.inst:DoTaskInTime(1, function()
	    self.page:SetFadeAlpha(0, true)
	    self.page:SetTexture("images/pageimages/"..self.page_bosses[newPageNumber]..".xml", ""..self.page_bosses[newPageNumber]..".tex")
	    self.page:SetSize(HUDHeight, HUDWidth)
	end)
...
function SDFBookOfGallowmerePageBosses:CreateLastPageTurnerEndAnimation(newPageNumber)
	--Stop fast animation
	self.turningPage = true
...
function SDFBookOfGallowmerePageBosses:CreateNextPageTurnerAnimation(newPageNumber)
	--Stop fast animation
	self.turningPage = true
...
function SDFBookOfGallowmerePageBosses:CreateNextPageTurnerEndAnimation(newPageNumber)
	--Stop fast animation
	self.turningPage = true
...
function SDFBookOfGallowmerePageBosses:CreateLastPageTurner()
	...
	lastPageTurner:SetOnClick(function()
		...
		if self.page_bosses[lastPageNumber] ~= nil then
		    self:CreateLastPageTurnerAnimation(lastPageNumber)
		    self.currentPage = lastPageNumber
		end
	    else
		if self.page_bosses[self.maxPageTotal] ~= nil then
...
function SDFBookOfGallowmerePageBosses:CreateNextPageTurner()
	...
	nextPageTurner:SetOnClick(function()
		...
		if self.page_bosses[nextPageNumber] ~= nil then
...
return SDFBookOfGallowmerePageBosses