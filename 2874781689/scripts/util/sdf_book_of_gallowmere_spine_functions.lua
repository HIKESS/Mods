SDF_BOOK_OF_GALLOWMERE_SPINEFUNCS = {}
...
function SDF_BOOK_OF_GALLOWMERE_SPINEFUNCS.MyWidgetSetup(self, prefab, data)
...
function SDF_BOOK_OF_GALLOWMERE_SPINEFUNCS.MyWidgetSetup_replica(self, prefab, data)
    mywidgetsetup(self, prefab, data)
