...
sdf_blunderbuss_knockback = State({
    name = "sdf_blunderbuss_knockback",
...
sdf_blunderbuss_shoot = State({
    name = "sdf_blunderbuss_shoot",
    ...
    timeline=
    {
	    ...
	    inst.SoundEmitter:PlaySound("dontstarve/creatures/together/toad_stool/spore_explode")
            ...
            if inst.components.combat:GetWeapon() and inst.components.combat:GetWeapon():HasTag("sdf_blunderbuss") and inst.components.combat.target ~= nil then
	    ...
	    inst.sg:GoToState("sdf_blunderbuss_knockback")
        end),
...
sdf_blunderbuss_shoot_client = State({
    name = "sdf_blunderbuss_shoot",
...
sdf_blunderbuss_bombard_castaoe = State({
    name = "sdf_blunderbuss_bombard_castaoe",
    tags = {"attack", "notalking", "abouttoattack"},
...
sdf_blunderbuss_bombard_castaoe_client = State({
    name = "sdf_blunderbuss_bombard_castaoe",
    tags = {"busy", "nointerrupt", "attack", "notalking", "abouttoattack"},
...
AddStategraphState("wilson", sdf_blunderbuss_knockback)
AddStategraphState("wilson", sdf_blunderbuss_shoot)
AddStategraphState("wilson_client", sdf_blunderbuss_shoot_client)
AddStategraphState("wilson", sdf_blunderbuss_bombard_castaoe)
AddStategraphState("wilson_client", sdf_blunderbuss_bombard_castaoe_client)
--------------------------------------------WILSON SG ACTIONHANDLER FOR ATTACK OVERRIDE---------------------------------------------------------------------------
...
local function NewDestStateATTACK(inst, action)
  ...
  if weapon and weapon:HasTag("sdf_blunderbuss_shoot") and not inst.components.health:IsDead() and not inst.sg:HasStateTag("attack") and inst.components.combat ~= nil then
    return "sdf_blunderbuss_shoot"
  else
...
local function NewClientDestStateATTACK(inst, action)
  ...
  if weapon and weapon:HasTag("sdf_blunderbuss_shoot") and not inst.sg:HasStateTag("attack") and inst.replica.combat then
    return "sdf_blunderbuss_shoot"
  else
...
AddStategraphPostInit('wilson', function(self)
    ...
    if action.invobject and action.invobject.prefab == "sdf_blunderbuss" then 
	return "sdf_blunderbuss_bombard_castaoe"
    end 
    end)
end)
