...
local SDFJack_Of_The_Green_Chess_KnightBrain = Class(Brain, function(self, inst)
...
function SDFJack_Of_The_Green_Chess_KnightBrain:OnStart()
...
return SDFJack_Of_The_Green_Chess_KnightBrain
