...
local START_FACE_DIST = 3 --3
local KEEP_FACE_DIST = 7 --7
local GO_HOME_DIST = 1 --8
local MAX_CHASE_TIME = 5 --5
local MAX_CHARGE_DIST = 7 --7
local CHASE_GIVEUP_DIST = 6 --6
local RUN_AWAY_DIST = 2 --2
local STOP_RUN_AWAY_DIST = 4 --4

local SDFJack_Of_The_Green_Chess_RookBrain = Class(Brain, function(self, inst)
...
function SDFJack_Of_The_Green_Chess_RookBrain:OnStart()
...
return SDFJack_Of_The_Green_Chess_RookBrain
