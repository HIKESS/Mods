...
AddClassPostConstruct("cameras/followcamera",function(inst)
        ...
        function inst:Apply()
            if inst.insdfenchantedearthtomb == true and inst.sdfenchantedearthtombpos ~= nil then
                inst.headingtarget = 0
                local K = 42.857142857143 * DEGREES
                local qL = 0
                local vfIyB = 30
                local quNsijN = inst.sdfenchantedearthtombpos
                local QUh2tc = 35
                local qboV = 0
...
AddClassPostConstruct(
    ...
    function(UBg54E)
        ...
        function UBg54E:ShowMap(Dn1Xi)
            if UBg54E.owner ~= nil and UBg54E.owner._insdfenchantedearthtombcamera ~= nil and UBg54E.owner._insdfenchantedearthtombcamera:value() ~= nil then
                return
            end
        ...
        function UBg54E:ToggleMap()
            if
                UBg54E.owner ~= nil and UBg54E.owner._insdfenchantedearthtombcamera ~= nil and UBg54E.owner._insdfenchantedearthtombcamera:value() ~= nil and
