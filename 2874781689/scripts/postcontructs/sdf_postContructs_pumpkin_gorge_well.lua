...
AddClassPostConstruct("cameras/followcamera",function(inst)
        ...
        function inst:Apply()
            if inst.insdfpumpkingorgewell == true and inst.sdfpumpkingorgewellpos ~= nil then
                inst.headingtarget = 0
                local K = 42.857142857143 * DEGREES
                local qL = 0
                local vfIyB = 30
                local quNsijN = inst.sdfpumpkingorgewellpos
                local QUh2tc = 35
                local qboV = 0
...
AddClassPostConstruct(
    ...
    function(UBg54E)
        ...
        function UBg54E:ShowMap(Dn1Xi)
            if UBg54E.owner ~= nil and UBg54E.owner._insdfpumpkingorgewellcamera ~= nil and UBg54E.owner._insdfpumpkingorgewellcamera:value() ~= nil then
                return
            end
        ...
        function UBg54E:ToggleMap()
            if
                UBg54E.owner ~= nil and UBg54E.owner._insdfpumpkingorgewellcamera ~= nil and UBg54E.owner._insdfpumpkingorgewellcamera:value() ~= nil and
