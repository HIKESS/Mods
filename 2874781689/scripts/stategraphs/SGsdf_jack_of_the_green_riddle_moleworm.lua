...
local MOLE_PEEK_INTERVAL = 15 --20
local MOLE_PEEK_VARIANCE = 5 --5
...
local actionhandlers =
{
    ...
    ActionHandler(ACTIONS.PICKUP, function(inst) --ACTIONS.STEALMOLEBAIT, function(inst)
...
local states =
{
    ...
    State{
	    ...
	    SpawnPrefab("green_leaves").Transform:SetPosition(x,_ -2,z)
...
return StateGraph("SGsdf_jack_of_the_green_riddle_moleworm", states, events, "idle", actionhandlers)
