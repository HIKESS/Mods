...
local states =
{
    State{
        ...
        onenter = function(inst)
            ...
            inst.sg.statemem.task = inst:DoTaskInTime(GetRandomWithVariance(inst.lifeSpan, 1), inst.PushEvent, "full_retreat")
...
return StateGraph("sdf_pumpking_gourd_vine", states, events, "idle")
